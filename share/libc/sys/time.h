...
//@ ghost __FC_INTERN volatile struct itimerval __fc_itimer_real;
//@ ghost __FC_INTERN volatile struct itimerval __fc_itimer_virtual;
//@ ghost __FC_INTERN volatile struct itimerval __fc_itimer_prof;
