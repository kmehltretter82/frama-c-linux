...
(** @before Frama-C+dev all these functions were at top level *)
module C : sig
  ...
  *)
  ...
  (** Returns the elements type using {!direct_array_element}, but if the
      resulting type is an array, recursively call {!array_element}.
  *)
...
[@@migrate { repl = Rel.C.get_attributes }]
...
[@@migrate { repl = Rel.C.add_attributes }]
...
[@@migrate { repl = Rel.C.has_attribute }]
...
[@@migrate { repl = Rel.C.has_qualifier }]
...
[@@migrate { repl = Rel.C.has_attribute_memory_block }]
...
[@@migrate { repl = Rel.C.remove_attributes }]
...
[@@migrate { repl = Rel.C.remove_all_attributes }]
...
[@@migrate { repl = Rel.C.remove_attributes_deep }]

(** Remove all attributes relative to const, volatile and restrict attributes. *)
val remove_qualifiers : typ -> typ
[@@deprecated "Use Ast_types.C.remove_qualifiers instead."]
[@@migrate { repl = Rel.C.remove_qualifiers }]

(** Remove also qualifiers under Ptr and Arrays. *)
val remove_qualifiers_deep : typ -> typ
[@@deprecated "Use Ast_types.C.remove_qualifiers_deep instead."]
[@@migrate { repl = Rel.C.remove_qualifiers_deep }]
...
[@@migrate { repl = Rel.C.remove_attributes_for_c_cast }]
...
[@@migrate { repl = Rel.C.remove_attributes_for_logic_type }]
...
[@@migrate { repl = Rel.C.unroll_deep }]

(** Same than {!unroll_deep} but discard the final type attributes and only
    return its node. *)
val unroll_deep_node : typ -> typ_node
[@@deprecated "Use Ast_types.C.unroll_deep_node instead."]
[@@migrate { repl = Rel.C.unroll_deep_node }]
...
[@@migrate { repl = Rel.C.is_volatile }]
...
[@@migrate { repl = Rel.C.is_wellformed_ghost }]
...
[@@migrate { repl = Rel.C.is_char }]

(** True if the argument is a character type (i.e. plain, signed or unsigned). *)
val is_any_char : typ -> bool
[@@deprecated "Use Ast_types.C.is_any_char instead."]
[@@migrate { repl = Rel.C.is_any_char }]
...
[@@migrate { repl = Rel.C.is_char_ptr }]
...
[@@migrate { repl = Rel.C.is_any_char_ptr }]
...
[@@migrate { repl = Rel.C.is_char_array }]
...
[@@migrate { repl = Rel.C.is_any_char_array }]
...
[@@migrate { repl = Rel.C.is_wchar_array }]

(** True if the argument is a function type. *)
val is_fun : typ -> bool
[@@deprecated "Use Ast_types.C.is_fun instead."]
[@@migrate { repl = Rel.C.is_fun }]
...
[@@migrate { repl = Rel.C.is_variadic }]

(** True if the argument is a function pointer type. *)
val is_fun_ptr : typ -> bool
[@@deprecated "Use Ast_types.C.is_fun_ptr instead."]
[@@migrate { repl = Rel.C.is_fun_ptr }]
...
[@@migrate { repl = Rel.C.is_fun_or_ptr }]
...
[@@migrate { repl = Rel.C.is_scalar }]

(** True if the argument is an object type (i.e. not a function type). *)
val is_object : typ -> bool
[@@deprecated "Use Ast_types.C.is_object instead."]
[@@migrate { repl = Rel.C.is_object }]
...
[@@migrate { repl = Rel.C.is_object_ptr }]

(** True if the argument is a struct. *)
val is_struct : typ -> bool
[@@deprecated "Use Ast_types.C.is_struct instead."]
[@@migrate { repl = Rel.C.is_struct }]
...
[@@migrate { repl = Rel.C.direct_array_element }]
...
[@@migrate { repl = Rel.C.array_element }]
...
[@@migrate { repl = Rel.C.array_elem_type_and_size }]
