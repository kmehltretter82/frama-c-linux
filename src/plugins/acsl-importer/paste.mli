...
val find_stmt_set_from_sid: ?source:Fileloc.t -> int -> Cil_datatype.Stmt.Set.t
val find_stmt_set_from_label: ?source:Fileloc.t -> string -> Cil_datatype.Stmt.Set.t
val find_stmt_set_from_return: ?source:Fileloc.t -> unit -> Cil_datatype.Stmt.Set.t
val find_stmt_set_from_call_to: ?source:Fileloc.t -> Kernel_function.t option -> int -> Cil_datatype.Stmt.Set.t
val find_stmt_set_from_call_number: ?source:Fileloc.t -> int -> Cil_datatype.Stmt.Set.t
val find_stmt_set_from_asm_number: ?source:Fileloc.t -> int -> Cil_datatype.Stmt.Set.t
val find_loop_stmt_set_from_loop_number: ?source:Fileloc.t -> int -> Cil_datatype.Stmt.Set.t
val find_loop_body_set_from_loop_number: ?source:Fileloc.t -> int -> Cil_datatype.Stmt.Set.t
