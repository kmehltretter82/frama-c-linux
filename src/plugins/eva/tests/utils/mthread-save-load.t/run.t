Parse file without option -mt-threads-lib
  $ frama-c file.c -save parsed.sav -no-autoload-plugins
  [kernel] Parsing file.c (with preprocessing)

Load parsed file and run Mthread: failure as Mthread files are missing.
  $ frama-c -load parsed.sav -mthread -no-autoload-plugins -load-module eva.mthread,inout,scope
...
Parse file with Mthread builtins only.
  $ frama-c file.c -save parsed.sav -mt-threads-lib builtins-only -no-autoload-plugins -load-module eva.mthread
...
Parse file with Mthread builtins and pthreads stubs.
  $ frama-c file.c -save parsed.sav -mt-threads-lib pthreads -no-autoload-plugins -load-module eva.mthread
...
The analysis succeeds and two alarms are emitted.
  $ frama-c -load parsed.sav -mthread -eva-verbose 0 -mt-verbose 0 -no-autoload-plugins -load-module eva.mthread,inout,scope
