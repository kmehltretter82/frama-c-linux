...
Help message about Eva builtins.
  ...
  ** Full list of builtins (configurable via -eva-builtin):
     ...
     Frama_C_offset, Frama_C_pow, Frama_C_powf, Frama_C_rawmemchr,
     Frama_C_realloc, Frama_C_reallocarray, Frama_C_round, Frama_C_roundf,
     Frama_C_sin, Frama_C_sinf, Frama_C_sqrt, Frama_C_sqrtf, Frama_C_strchr,
     Frama_C_strlen, Frama_C_strnlen, Frama_C_trunc, Frama_C_truncf,
     Frama_C_ungarble, Frama_C_vla_alloc, Frama_C_vla_free,
