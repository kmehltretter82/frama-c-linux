/* run.config*
   STDOPT: #"-kernel-warn-key parser:decimal-float=warning -float-print hex"
   STDOPT: #"-kernel-warn-key parser:decimal-float=warning -float-print hex -warn-special-float none"
*/
