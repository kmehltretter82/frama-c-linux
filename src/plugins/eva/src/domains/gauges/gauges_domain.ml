...
module G = struct
  ...
  *)
  ...
  let forget nb mv mc =
    ...
    let both b v i =
      ...
      let v' = Cvalue.V.add_untyped ~factor:Z.one v p in
      MV.singleton b v'
    in
    let join = MV.merge_disjoint in
    MV.fold2_join_heterogeneous
  ...
  *)
  ...
  let tracked_variable vi =
    Ast_types.C.is_integral_or_pointer vi.Cil_types.vtype &&
  ...
  module Gauge = struct
    ...
    let add (ct1, l1: t) (ct2, l2: t) : t =
      let ct = Cvalue.V.add_untyped ~factor:Z.one ct1 ct2 in
  ...
  let eval_gauge (_ct, l: t) (ctg, lg: Gauge.t) =
    ...
    Cvalue.V.add_untyped ctg ~factor:Z.one shift
