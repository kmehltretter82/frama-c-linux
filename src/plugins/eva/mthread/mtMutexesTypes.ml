...
type access_or_protection = Unaccessed | Mutexes of presence
...
module LatticeMutexes = struct
  include Datatype.Make(
    struct
      ...
      let reprs = [{ mutexes_for_read = Mutexes Presence.empty;
                     mutexes_for_write = Mutexes Presence.empty }]
  ...
  let top = { mutexes_for_read = Mutexes Presence.empty;
              mutexes_for_write = Mutexes Presence.empty }
