...
let forward_binop _ _ op v1 v2 =
  match op with
...
let forward_cast _ ~src_type ~dst_type v =
...
let backward_unop _ ~typ_arg:_ _op ~arg:_ ~res:_ = `Value None
(* Not implemented precisely *)
