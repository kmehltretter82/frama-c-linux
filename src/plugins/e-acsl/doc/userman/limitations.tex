...
\begin{logs}
\$ e-acsl-gcc uninitialized.i -c -Omonitored_uninitialized
...
\begin{logs}
\$ e-acsl-gcc -M -omonitored_valid_no_main.i valid_no_main.c
...
\begin{logs}
\$ e-acsl-gcc -M -omonitored_modified_main.i modified_main.c
