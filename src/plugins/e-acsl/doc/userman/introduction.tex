...
existing analyzers with other \C analyzers
such as \pathcrawler~\cite{pathcrawler} that do not natively understand the \acsl
...
provides examples, it is not a \emph{not} a full comprehensive tutorial on
\framac or \eacsl.
