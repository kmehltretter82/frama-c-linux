/* run.config
   COMMENT: https://toccata.gitlabpages.inria.fr/toccata/gallery/SelectionSortACSL.en.html
   COMMENT: Inductive extraction does not succeed, because Permut_swap cannot bind i and j.
