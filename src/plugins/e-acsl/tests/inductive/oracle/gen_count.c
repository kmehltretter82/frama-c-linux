...
int main(void)
{
  ...
  /*@ assert CountInd(ptr, 2, 3, 0); */ ;
  {
    ...
    /*@ assert E_ACSL: uninitialized: \initialized(&ptr); */
    {
      ...
      __gen_e_acsl_assert_data_8.pred_txt = "\\initialized(&ptr)";
  ...
  if (__gen_e_acsl_and) __gen_e_acsl_or_2 = 1;
    ...
    if (__gen_e_acsl_lt < 0) {
      ...
      __e_acsl_assert_data_t __gen_e_acsl_assert_data_3 =
        {.values = (void *)0};
      __gen_e_acsl_aligned = __e_acsl_aligned((void *)(arr + __gen_e_acsl__7),
                                              _Alignof(int));
      ...
      __e_acsl_assert_register_long(& __gen_e_acsl_assert_data_3,
                                    "__gen_e_acsl__7",0,__gen_e_acsl__7);
      __gen_e_acsl_assert_data_3.blocking = 1;
      __gen_e_acsl_assert_data_3.kind = "RTE";
      __gen_e_acsl_assert_data_3.pred_txt = "\\aligned(arr + __gen_e_acsl__7,alignof(int))";
    ...
    if (__gen_e_acsl_and_4) __gen_e_acsl_or = 1;
      ...
      if (__gen_e_acsl_lt_2 < 0) {
        ...
        __e_acsl_assert_data_t __gen_e_acsl_assert_data_4 =
          {.values = (void *)0};
        __gen_e_acsl_aligned_2 = __e_acsl_aligned((void *)(arr + __gen_e_acsl__12),
                                                  _Alignof(int));
        ...
        __e_acsl_assert_register_long(& __gen_e_acsl_assert_data_4,
                                      "__gen_e_acsl__12",0,__gen_e_acsl__12);
        __gen_e_acsl_assert_data_4.blocking = 1;
        __gen_e_acsl_assert_data_4.kind = "RTE";
        __gen_e_acsl_assert_data_4.pred_txt = "\\aligned(arr + __gen_e_acsl__12,alignof(int))";
