...
int main(void)
{
  ...
  __e_acsl_full_init((void *)(& cArr));
  {
    ...
    __gen_e_acsl_assert_data_3.pred_txt = "linked_n(&root, (struct list **)cArr, 0, 2, (struct list *)0)";
  ...
  /*@ assert linked_n(&root, (struct list **)cArr, 0, 2, (struct list *)0);
   */
  ;
  ...
  __e_acsl_full_init((void *)(& cArr2));
  {
    ...
    __gen_e_acsl_assert_data_4.pred_txt = "!linked_n(&root, (struct list **)cArr2, 0, 2, (struct list *)0)";
  ...
  /*@ assert !linked_n(&root, (struct list **)cArr2, 0, 2, (struct list *)0);
   */
  ;
  __retres = 0;
