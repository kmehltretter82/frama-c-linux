...
char *__gen_e_acsl_strchr(char const *s, int c)
{
  ...
  __retres = strchr(s,c);
  {
    ...
    if (__gen_e_acsl_assumes_value) {
      ...
      __gen_e_acsl_assert_data_4.line = 194;
      ...
      __gen_e_acsl_assert_data_5.line = 195;
      ...
      __gen_e_acsl_assert_data_3.line = 194;
    ...
    if (__gen_e_acsl_assumes_value) {
      ...
      __gen_e_acsl_assert_data_8.line = 201;
 ...
 __attribute__((__noreturn__)) void __gen_e_acsl_exit(int status)
{
  exit(status);
  {
    ...
    __gen_e_acsl_assert_data.line = 740;
 ...
 __attribute__((__noreturn__)) void __gen_e_acsl_abort(void)
{
  abort();
  {
    ...
    __gen_e_acsl_assert_data.line = 726;
    __gen_e_acsl_assert_data.name = "never_terminates";
    __e_acsl_assert(0,& __gen_e_acsl_assert_data);
    return;
  }
