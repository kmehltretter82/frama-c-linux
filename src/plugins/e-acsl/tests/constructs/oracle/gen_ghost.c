...
int main(void)
{
  ...
  }
  {
    ...
    __gen_e_acsl_assert_data_6.pred_txt = "\\let x = ghost_int_arr[0]; \\true";
    __gen_e_acsl_assert_data_6.file = "ghost.i";
