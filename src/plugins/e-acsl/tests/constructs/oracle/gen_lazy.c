...
int main(void)
{
  ...
  /*@ assert !(x != 0 && y == 1 / 0); */ ;
  {
    ...
    __gen_e_acsl_assert_data_3.pred_txt = "y == 1 || x == 1";
  ...
  /*@ assert x == 0 || y == 1 / 0; */ ;
  {
    ...
    __gen_e_acsl_assert_data_5.pred_txt = "x == 0 ==> y == 1";
    __gen_e_acsl_assert_data_5.file = "lazy.i";
    __gen_e_acsl_assert_data_5.fct = "main";
    __gen_e_acsl_assert_data_5.line = 13;
    __e_acsl_assert(__gen_e_acsl_implies,& __gen_e_acsl_assert_data_5);
  ...
  /*@ assert x == 0 ==> y == 1; */ ;
  {
    ...
    __gen_e_acsl_assert_data_6.pred_txt = "x == 1 ==> y == 1 / 0";
    __gen_e_acsl_assert_data_6.file = "lazy.i";
    __gen_e_acsl_assert_data_6.fct = "main";
    __gen_e_acsl_assert_data_6.line = 14;
    __e_acsl_assert(__gen_e_acsl_implies_2,& __gen_e_acsl_assert_data_6);
  ...
  /*@ assert x == 1 ==> y == 1 / 0; */ ;
  {
    ...
    __gen_e_acsl_assert_data_7.pred_txt = "x != 0 ? x != 0 : y != 0";
    __gen_e_acsl_assert_data_7.file = "lazy.i";
    __gen_e_acsl_assert_data_7.fct = "main";
    __gen_e_acsl_assert_data_7.line = 15;
    __e_acsl_assert(__gen_e_acsl_if,& __gen_e_acsl_assert_data_7);
  ...
  /*@ assert x != 0 ? x != 0 : y != 0; */ ;
  {
    ...
    __gen_e_acsl_assert_data_8.pred_txt = "y != 0 ? y != 0 : x != 0";
    __gen_e_acsl_assert_data_8.file = "lazy.i";
    __gen_e_acsl_assert_data_8.fct = "main";
    __gen_e_acsl_assert_data_8.line = 16;
    __e_acsl_assert(__gen_e_acsl_if_2,& __gen_e_acsl_assert_data_8);
  ...
  /*@ assert y != 0 ? y != 0 : x != 0; */ ;
  {
    ...
    __gen_e_acsl_assert_data_9.pred_txt = "x == 1 ? x == 18 : x == 0";
    __gen_e_acsl_assert_data_9.file = "lazy.i";
    __gen_e_acsl_assert_data_9.fct = "main";
    __gen_e_acsl_assert_data_9.line = 17;
    __e_acsl_assert(__gen_e_acsl_if_3,& __gen_e_acsl_assert_data_9);
  ...
  /*@ assert x == 1 ? x == 18 : x == 0; */ ;
  {
    ...
    __gen_e_acsl_assert_data_10.pred_txt = "x == 2 <==> y == 3";
  ...
  /*@ assert x == 0 <==> y == 1; */ ;
  {
    ...
    __gen_e_acsl_assert_data_12.pred_txt = "((x != 0 ? x : y) != 0) == (x == 0)";
  ...
  /*@ assert (x != 0 && y != 0) || y != 0; */ ;
  {
    ...
    __gen_e_acsl_assert_data_14.pred_txt = "(x != 0 || y != 0) && y == 1";
  ...
  /*@ assert (x != 0 || y != 0) && y == 1; */ ;
  {
    ...
    __gen_e_acsl_assert_data_15.pred_txt = "(x != 0 || y != 0) == (y != 0)";
  ...
  /*@ assert (x != 0 || y != 0) == (y != 0); */ ;
  {
    ...
    __gen_e_acsl_assert_data_16.pred_txt = "(x != 0 && y != 0) == (x != 0)";
