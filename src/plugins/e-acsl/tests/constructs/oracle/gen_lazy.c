...
int main(void)
{
  ...
  /*@ assert x == 1 ? x == 18 : x == 0; */ ;
  {
    ...
    if (__gen_e_acsl_implies_3) {
      ...
      __gen_e_acsl_and_3 = __gen_e_acsl_implies_4;
    }
  ...
  /*@ assert x == 2 <==> y == 3; */ ;
  {
    ...
    if (__gen_e_acsl_implies_5) {
      ...
      __gen_e_acsl_and_4 = __gen_e_acsl_implies_6;
    }
  ...
  /*@ assert (x != 0 && y != 0) || y != 0; */ ;
  {
    ...
    __e_acsl_assert(__gen_e_acsl_and_6,& __gen_e_acsl_assert_data_17);
  ...
  /*@ assert (x != 0 || y != 0) == (y != 0); */ ;
  {
    ...
    __e_acsl_assert(__gen_e_acsl_and_7 == (x != 0),
