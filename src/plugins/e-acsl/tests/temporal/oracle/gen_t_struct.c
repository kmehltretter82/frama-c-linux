...
int main(void)
{
  ...
  /*@ assert \valid(t1.p) && \valid(t1.q); */ ;
  {
    ...
    __gen_e_acsl_assert_data_2.pred_txt = "!(\\initialized(&t2.p) && \\valid(t2.p)) &&\n!(\\initialized(&t2.q) && \\valid(t2.q))";
  ...
  __e_acsl_temporal_store_nblock((void *)(& t2.q),(void *)*(& t2.q));
  {
    ...
    __gen_e_acsl_assert_data_4.pred_txt = "!(\\initialized(&t2.p) && \\valid(t2.p)) && \\valid(t2.q)";
  ...
  l.t = t2;
  {
    ...
    __gen_e_acsl_assert_data_5.pred_txt = "!(\\initialized(&l.t.p) && \\valid(l.t.p)) && \\valid(l.t.q)";
    __gen_e_acsl_assert_data_5.file = "t_struct.c";
    __gen_e_acsl_assert_data_5.fct = "main";
    __gen_e_acsl_assert_data_5.line = 41;
    __e_acsl_assert(__gen_e_acsl_and_9,& __gen_e_acsl_assert_data_5);
  ...
  lp = & l;
  {
    ...
    __gen_e_acsl_assert_data_6.pred_txt = "!(\\initialized(&lp->t.p) && \\valid(lp->t.p))";
    __gen_e_acsl_assert_data_6.file = "t_struct.c";
    __gen_e_acsl_assert_data_6.fct = "main";
    __gen_e_acsl_assert_data_6.line = 44;
    __e_acsl_assert(! __gen_e_acsl_and_10,& __gen_e_acsl_assert_data_6);
  ...
  tarr[0] = t2;
  {
    ...
    __gen_e_acsl_initialized_6 = __e_acsl_initialized((void *)(& tarr[0].p),
                                                      sizeof(char *));
    __e_acsl_assert_register_ptr(& __gen_e_acsl_assert_data_7,"&tarr[0].p",
                                 (void *)(& tarr[0].p));
    ...
    if (! __gen_e_acsl_and_11) {
      ...
      __gen_e_acsl_valid_13 = __e_acsl_valid((void *)tarr[0].q,sizeof(char),
                                             (void *)tarr[0].q,
                                             (void *)(& tarr[0].q));
      __e_acsl_assert_register_ptr(& __gen_e_acsl_assert_data_7,"tarr[0].q",
                                   (void *)tarr[0].q);
      __e_acsl_assert_register_ulong(& __gen_e_acsl_assert_data_7,
                                     "sizeof(char)",0,sizeof(char));
      __e_acsl_assert_register_int(& __gen_e_acsl_assert_data_7,
    ...
    __gen_e_acsl_assert_data_7.pred_txt = "!(\\initialized(&tarr[0].p) && \\valid(tarr[0].p)) && \\valid(tarr[0].q)";
  ...
  larr[0] = l;
  {
    ...
    __gen_e_acsl_initialized_7 = __e_acsl_initialized((void *)(& larr[0].t.p),
                                                      sizeof(char *));
    __e_acsl_assert_register_ptr(& __gen_e_acsl_assert_data_8,"&larr[0].t.p",
                                 (void *)(& larr[0].t.p));
    ...
    __gen_e_acsl_assert_data_8.pred_txt = "!(\\initialized(&larr[0].t.p) && \\valid(larr[0].t.p)) && \\valid(larr[0].t.q)";
    __gen_e_acsl_assert_data_8.file = "t_struct.c";
    __gen_e_acsl_assert_data_8.fct = "main";
    __gen_e_acsl_assert_data_8.line = 50;
    __e_acsl_assert(__gen_e_acsl_and_14,& __gen_e_acsl_assert_data_8);
