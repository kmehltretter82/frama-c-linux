                            ...
                            char * restrict resolved_name)
{
  ...
  __e_acsl_store_block((void *)(& __retres),8UL);
  {
    ...
    __gen_e_acsl_assert_data_2.line = 1039;
  ...
  __e_acsl_temporal_store_nblock((void *)(& __retres),(void *)*(& __retres));
  {
    ...
    if (__gen_e_acsl_assumes_value) {
      ...
      __gen_e_acsl_assert_data_4.line = 1050;
      ...
      __gen_e_acsl_assert_data_3.line = 1049;
    ...
    if (__gen_e_acsl_assumes_value) {
      ...
      __gen_e_acsl_assert_data_7.line = 1065;
      ...
      __gen_e_acsl_assert_data_6.line = 1064;
    ...
    if (__gen_e_acsl_assumes_value) {
      ...
      __gen_e_acsl_assert_data_9.line = 1077;
    ...
    if (__gen_e_acsl_assumes_value) {
      ...
      __gen_e_acsl_assert_data_10.line = 1083;
