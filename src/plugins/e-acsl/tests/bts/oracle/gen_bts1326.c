                                                 ...
                                                 int *AverageAccel)
{
  ...
  atp_NORMAL_computeAverageAccel(Accel,AverageAccel);
  {
    ...
    __gen_e_acsl_assert_data_3.pred_txt = "mem_access: \\valid_read((int *)*__gen_e_acsl_at_6)";
    ...
    __gen_e_acsl_assert_data_4.pred_txt = "mem_access: \\valid_read(&(*__gen_e_acsl_at_5)[1])";
    ...
    __gen_e_acsl_assert_data_5.pred_txt = "mem_access: \\valid_read(&(*__gen_e_acsl_at_4)[2])";
    ...
    __gen_e_acsl_assert_data_6.pred_txt = "mem_access: \\valid_read(&(*__gen_e_acsl_at_3)[3])";
    ...
    __gen_e_acsl_assert_data_7.pred_txt = "mem_access: \\valid_read(&(*__gen_e_acsl_at_2)[4])";
    ...
    __gen_e_acsl_assert_data_8.pred_txt = "mem_access: \\valid_read(__gen_e_acsl_at)";
    __gen_e_acsl_assert_data_8.file = "tests/bts/bts1326.i";
