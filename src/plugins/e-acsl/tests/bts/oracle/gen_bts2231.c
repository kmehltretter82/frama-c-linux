...
int main(void)
{
  ...
  /*@ assert A+(long)((long)(3*A)-1) ≡ -1; */
  {
    ...
    __gmpz_init_set_si(__gen_e_acsl__3,__gen_e_acsl__2);
    ...
    __gen_e_acsl__5 = __gmpz_get_si((__e_acsl_mpz_struct const *)(__gen_e_acsl_sub));
    __gmpz_init_set_si(__gen_e_acsl__6,__gen_e_acsl__5);
