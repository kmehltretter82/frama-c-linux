  ...
  */
  while (len) {
    ...
    while (1) {
      ...
      {
        long __gen_e_acsl_i_3_2;
        int __gen_e_acsl_valid_read_2;
        int __gen_e_acsl_aligned_2;
        __gen_e_acsl_i_3_2 = __gmpz_get_si((__e_acsl_mpz_struct const *)(__gen_e_acsl_i_3));
        __e_acsl_assert_data_t __gen_e_acsl_assert_data_5 =
          {.values = (void *)0};
        __gen_e_acsl_valid_read_2 = __e_acsl_valid_read((void *)(a + __gen_e_acsl_i_3_2),
                                                        sizeof(int const),
                                                        (void *)a,
                                                        (void *)(& a));
        ...
        __gen_e_acsl_assert_data_5.pred_txt = "\\valid_read(a + __gen_e_acsl_i_3_2)";
        ...
        __e_acsl_assert_data_t __gen_e_acsl_assert_data_6 =
          {.values = (void *)0};
        __gen_e_acsl_aligned_2 = __e_acsl_aligned((void *)(a + __gen_e_acsl_i_3_2),
                                                  _Alignof(int const));
        ...
        __gen_e_acsl_assert_data_6.pred_txt = "\\aligned(a + __gen_e_acsl_i_3_2,alignof(int const))";
        ...
        /*@ assert Eva: mem_access: \valid_read(a + __gen_e_acsl_i_3_2); */
        if (*(a + __gen_e_acsl_i_3_2) != value) ;
        else {
