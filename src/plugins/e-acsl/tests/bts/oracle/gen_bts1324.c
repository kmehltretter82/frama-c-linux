  ...
  int __retres;
  {
    ...
    while (1) {
      if (__gen_e_acsl_i < n) ; else break;
      {
        ...
        __gen_e_acsl_assert_data_2.pred_txt = "\\aligned(t + __gen_e_acsl_i,alignof(int))";
        ...
        __gen_e_acsl_assert_data_4.pred_txt = "\\valid_read(t + (long)(__gen_e_acsl_i - 1))";
        ...
        __gen_e_acsl_assert_data_5.pred_txt = "\\aligned(t + (long)(__gen_e_acsl_i - 1),alignof(int))";
