...
int main(void)
{
  ...
  /*@ assert -3 ≡ x; */
  {
    ...
    int __gen_e_acsl_eq;
    __gmpz_init_set_ui(__gen_e_acsl_,3UL);
  ...
  /*@ assert x ≡ -3; */
  {
    ...
    __gmpz_init_set_ui(__gen_e_acsl__2,3UL);
  ...
  /*@ assert x+1 ≡ -2; */
  {
    ...
    __gmpz_init_set_ui(__gen_e_acsl__5,2UL);
  ...
  /*@ assert x-1 ≡ -4; */
  {
    ...
    __gmpz_init_set_ui(__gen_e_acsl__6,1UL);
    ...
    __gmpz_init_set_ui(__gen_e_acsl__7,4UL);
  ...
  /*@ assert x*3 ≡ -9; */
  {
    ...
    __gmpz_init_set_ui(__gen_e_acsl__8,3UL);
    ...
    __gmpz_init_set_ui(__gen_e_acsl__9,9UL);
  ...
  /*@ assert x/3 ≡ -1; */
  {
    ...
    __gmpz_init_set_ui(__gen_e_acsl__10,3UL);
  ...
  /*@ assert 0xffffffffffffffffffffff/0xffffffffffffffffffffff ≡ 1; */
  {
    ...
    __gmpz_tdiv_q(__gen_e_acsl_div_2,
                  ...
                  (__mpz_struct const *)(__gen_e_acsl__13));
    __gmpz_init_set_ui(__gen_e_acsl__15,1UL);
  ...
  /*@ assert x%2 ≡ -1; */
  {
    ...
    __gmpz_init_set_ui(__gen_e_acsl__16,2UL);
  ...
  /*@ assert -3%-2 ≡ -1; */
  {
    ...
    __gmpz_init_set_ui(__gen_e_acsl__22,1UL);
  ...
  /*@ assert 3%-2 ≡ 1; */
  {
    ...
    __gmpz_init_set_ui(__gen_e_acsl__23,3UL);
    __gmpz_init_set_ui(__gen_e_acsl__24,2UL);
    ...
    __gmpz_init_set_ui(__gen_e_acsl__26,1UL);
  ...
  /*@ assert ((x*2+(3+y))-4)+(x-y) ≡ -10; */
  {
    ...
    __gmpz_init_set_ui(__gen_e_acsl__27,2UL);
    ...
    __gmpz_init_set_ui(__gen_e_acsl__28,3UL);
    ...
    __gmpz_init_set_ui(__gen_e_acsl__29,4UL);
    ...
    __gmpz_init_set_ui(__gen_e_acsl__30,10UL);
  ...
  /*@ assert (0≡1) ≡ !(0≡0); */
  {
    ...
    __gmpz_init_set_ui(__gen_e_acsl__31,0UL);
    __gmpz_init_set_ui(__gen_e_acsl__32,1UL);
  ...
  /*@ assert (0≥-1) ≡ (0≤0); */
  {
    ...
    __gmpz_init_set_ui(__gen_e_acsl__40,0UL);
    __gmpz_init_set_ui(__gen_e_acsl__41,1UL);
  ...
  /*@ assert (0≢1) ≡ !(0≢0); */
  {
    ...
    __gmpz_init_set_ui(__gen_e_acsl__44,0UL);
    __gmpz_init_set_ui(__gen_e_acsl__45,1UL);
  ...
  /*@ assert (0≢0) ≡ !(1≢0); */
  {
    ...
    __gmpz_init_set_ui(__gen_e_acsl__49,0UL);
    ...
    __gmpz_init_set_ui(__gen_e_acsl__51,1UL);
  ...
  /*@ assert 4/y ≡ 2; */
  {
    ...
    __gmpz_init_set_ui(__gen_e_acsl__54,4UL);
    ...
    __gmpz_init_set_ui(__gen_e_acsl__56,2UL);
  ...
  /*@ assert 1+(z+1)/(y-123456789123456789) ≡ 1; */
  {
    ...
    __gmpz_init_set_ui(__gen_e_acsl__57,1UL);
