...
int main(void)
{
  ...
  /*@ assert \let n = 1; 4 ≡ n + 3.0; */
  {
    ...
    __gmpq_set_str(__gen_e_acsl__22,"4",10);
    __gmpq_init(__gen_e_acsl__23);
    __gmpq_set_d(__gen_e_acsl__23,3.);
    ...
    __gen_e_acsl_eq_4 = __gmpq_cmp((__e_acsl_mpq_struct const *)(__gen_e_acsl__22),
