/* run.config
   COMMENT: quantifiers
   COMMENT: no diff
   EXECNOW: LOG gen_quantif2.c BIN gen_quantif2.out @frama-c@ -e-acsl-share ./share/e-acsl ./tests/gmp/quantif.i -e-acsl-gmp-only -e-acsl -then-on e-acsl -print -ocode ./tests/gmp/result/gen_quantif2.c > /dev/null && ./gcc_runtime.sh quantif2
*/
