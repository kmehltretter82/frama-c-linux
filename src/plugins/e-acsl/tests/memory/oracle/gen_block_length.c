...
int main(void)
{
  ...
  PA ++;
  {
    ...
    __gen_e_acsl_assert_data_6.pred_txt = "\\block_length(PA + 1) == \\block_length(&A[1])";
  ...
  /*@ assert \block_length((int *)a) == sizeof(a); */ ;
  {
    ...
    __e_acsl_assert_register_ptr(& __gen_e_acsl_assert_data_10,"&a[3]",
                                 (void *)(& a[3]));
    __e_acsl_assert_register_ulong(& __gen_e_acsl_assert_data_10,
                                   "\\block_length(&a[3])",0,
                                   __gen_e_acsl_block_length_7);
    __e_acsl_assert_register_int(& __gen_e_acsl_assert_data_10,"sizeof(a)",0,
                                 16);
    __gen_e_acsl_assert_data_10.blocking = 1;
    __gen_e_acsl_assert_data_10.kind = "Assertion";
    __gen_e_acsl_assert_data_10.pred_txt = "\\block_length(&a[3]) == sizeof(a)";
  ...
  pa ++;
  {
    ...
    __e_acsl_assert_register_ptr(& __gen_e_acsl_assert_data_12,"&a[1]",
                                 (void *)(& a[1]));
    __e_acsl_assert_register_ulong(& __gen_e_acsl_assert_data_12,
                                   "\\block_length(&a[1])",0,
    ...
    __gen_e_acsl_assert_data_12.pred_txt = "\\block_length(pa + 1) == \\block_length(&a[1])";
  ...
  /*@ assert \block_length(pl) == sizeof(long); */ ;
  {
    ...
    __gen_e_acsl_assert_data_15.pred_txt = "\\block_length(pl + 7) == sizeof(long)";
  ...
  __e_acsl_full_init((void *)(& pi));
  {
    ...
    __gen_e_acsl_assert_data_16.pred_txt = "\\block_length(pi) == \\block_length(&l)";
  ...
  pi ++;
  {
    ...
    __e_acsl_assert_register_ptr(& __gen_e_acsl_assert_data_17,"&l",
                                 (void *)(& l));
    __e_acsl_assert_register_ulong(& __gen_e_acsl_assert_data_17,
                                   "\\block_length(&l)",0,
    ...
    __gen_e_acsl_assert_data_17.pred_txt = "\\block_length(pi) == \\block_length(&l)";
  ...
  __e_acsl_full_init((void *)(& p));
  {
    ...
    __gen_e_acsl_assert_data_18.pred_txt = "\\block_length(p) == size";
  ...
  /*@ assert \block_length(p) == size; */ ;
  {
    ...
    __e_acsl_assert_register_ulong(& __gen_e_acsl_assert_data_19,"size",0,
                                   size);
    __gen_e_acsl_assert_data_19.blocking = 1;
    __gen_e_acsl_assert_data_19.kind = "Assertion";
    __gen_e_acsl_assert_data_19.pred_txt = "\\block_length(p + 11) == size";
  ...
  p += 5;
  {
    ...
    __gen_e_acsl_assert_data_20.pred_txt = "\\block_length(p + 5) == \\block_length(p - 5)";
    __gen_e_acsl_assert_data_20.file = "block_length.c";
    __gen_e_acsl_assert_data_20.fct = "main";
    __gen_e_acsl_assert_data_20.line = 46;
  ...
  __e_acsl_full_init((void *)(& q));
  {
    ...
    __e_acsl_assert_register_ulong(& __gen_e_acsl_assert_data_21,"size",0,
                                   size);
    __gen_e_acsl_assert_data_21.blocking = 1;
    __gen_e_acsl_assert_data_21.kind = "Assertion";
    __gen_e_acsl_assert_data_21.pred_txt = "\\block_length(q) == size";
  ...
  q += 4;
  {
    ...
    __gen_e_acsl_assert_data_22.pred_txt = "\\block_length(q) == size";
