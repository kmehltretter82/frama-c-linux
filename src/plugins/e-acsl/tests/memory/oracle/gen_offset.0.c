...
int main(void)
{
  ...
  /*@ assert \offset(&l) == 0; */ ;
  {
    ...
    /*@ assert E_ACSL: uninitialized: \initialized(&pl); */
    {
      ...
      __gen_e_acsl_assert_data_13.pred_txt = "\\initialized(&pl)";
  ...
  /*@ assert \offset(pl) == 0; */ ;
  {
    ...
    /*@ assert E_ACSL: uninitialized: \initialized(&pl); */
    {
      ...
      __gen_e_acsl_assert_data_16.pred_txt = "\\initialized(&pl)";
  ...
  /*@ assert \offset(pl + 1) == 1; */ ;
  {
    ...
    /*@ assert E_ACSL: "pointer alignment": \aligned(pl,1); */
    {
      ...
      __gen_e_acsl_assert_data_18.pred_txt = "\\aligned(pl,1)";
      ...
      __e_acsl_assert(__gen_e_acsl_aligned_5,& __gen_e_acsl_assert_data_18);
    ...
    /*@ assert E_ACSL: uninitialized: \initialized(&pl); */
    {
      ...
      __gen_e_acsl_assert_data_19.pred_txt = "\\initialized(&pl)";
  ...
  __e_acsl_full_init((void *)(& pi));
  {
    ...
    /*@ assert E_ACSL: "pointer alignment": \aligned(pi,4); */
    {
      ...
      __e_acsl_assert(__gen_e_acsl_aligned_6,& __gen_e_acsl_assert_data_21);
    ...
    /*@ assert E_ACSL: uninitialized: \initialized(&pi); */
    {
      ...
      __gen_e_acsl_assert_data_22.pred_txt = "\\initialized(&pi)";
  ...
  pi ++;
  {
    ...
    /*@ assert E_ACSL: "pointer alignment": \aligned(pi,4); */
    {
      ...
      __gen_e_acsl_assert_data_24.pred_txt = "\\aligned(pi,4)";
    ...
    /*@ assert E_ACSL: uninitialized: \initialized(&pi); */
    {
      ...
      __gen_e_acsl_assert_data_25.pred_txt = "\\initialized(&pi)";
  ...
  __e_acsl_full_init((void *)(& p));
  {
    ...
    /*@ assert E_ACSL: "pointer alignment": \aligned(p,1); */
    {
      ...
      __e_acsl_assert(__gen_e_acsl_aligned_8,& __gen_e_acsl_assert_data_27);
  ...
  /*@ assert \offset(p) == 0; */ ;
  {
    ...
    /*@ assert E_ACSL: "pointer alignment": \aligned(p,1); */
    {
      ...
      __e_acsl_assert(__gen_e_acsl_aligned_9,& __gen_e_acsl_assert_data_30);
    ...
    __gen_e_acsl_initialized_7 = __e_acsl_initialized((void *)(& p),
                                                      sizeof(char *));
    __e_acsl_assert_register_ptr(& __gen_e_acsl_assert_data_31,"&p",
                                 (void *)(& p));
  ...
  /*@ assert \offset(p + 1) == 1; */ ;
  {
    ...
    /*@ assert E_ACSL: "pointer alignment": \aligned(p,1); */
    {
      ...
      __e_acsl_assert(__gen_e_acsl_aligned_10,& __gen_e_acsl_assert_data_33);
    ...
    __gen_e_acsl_initialized_8 = __e_acsl_initialized((void *)(& p),
                                                      sizeof(char *));
    __e_acsl_assert_register_ptr(& __gen_e_acsl_assert_data_34,"&p",
                                 (void *)(& p));
  ...
  p += 5;
  {
    ...
    /*@ assert E_ACSL: "pointer alignment": \aligned(p,1); */
    {
      ...
      __e_acsl_assert(__gen_e_acsl_aligned_11,& __gen_e_acsl_assert_data_36);
  ...
  /*@ assert \offset(p + 5) == 10; */ ;
  {
    ...
    /*@ assert E_ACSL: "pointer alignment": \aligned(p,1); */
    {
      ...
      __e_acsl_assert(__gen_e_acsl_aligned_12,& __gen_e_acsl_assert_data_39);
  ...
  __e_acsl_full_init((void *)(& q));
  {
    ...
    /*@ assert E_ACSL: "pointer alignment": \aligned(q,8); */
    {
      ...
      __gen_e_acsl_assert_data_42.pred_txt = "\\aligned(q,8)";
    ...
    __gen_e_acsl_initialized_11 = __e_acsl_initialized((void *)(& q),
                                                       sizeof(long *));
    __e_acsl_assert_register_ptr(& __gen_e_acsl_assert_data_43,"&q",
                                 (void *)(& q));
  ...
  q += 2;
  {
    ...
    /*@ assert E_ACSL: "pointer alignment": \aligned(q,8); */
    {
      ...
      __e_acsl_assert(__gen_e_acsl_aligned_15,& __gen_e_acsl_assert_data_48);
  ...
  q += 4;
  {
    ...
    /*@ assert E_ACSL: "pointer alignment": \aligned(q,8); */
    {
      ...
      __gen_e_acsl_assert_data_51.pred_txt = "\\aligned(q,8)";
      ...
      __e_acsl_assert(__gen_e_acsl_aligned_16,& __gen_e_acsl_assert_data_51);
    ...
    __gen_e_acsl_initialized_14 = __e_acsl_initialized((void *)(& q),
                                                       sizeof(long *));
    __e_acsl_assert_register_ptr(& __gen_e_acsl_assert_data_52,"&q",
                                 (void *)(& q));
    ...
    /*@ assert E_ACSL: uninitialized: \initialized(&q); */
    {
      ...
      __gen_e_acsl_assert_data_52.pred_txt = "\\initialized(&q)";
