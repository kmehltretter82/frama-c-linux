...
int __gen_e_acsl_main(int argc, char **argv)
{
  ...
  /*@ assert *(argv + argc) == \null; */ ;
  {
    ...
    __gen_e_acsl_assert_data_4.pred_txt = "!\\valid(*(argv + argc))";
  ...
  while (i < argc) {
    {
      ...
      int len = (int)tmp;
      {
        ...
        __gen_e_acsl_assert_data_5.pred_txt = "\\valid(*(argv + i))";
      ...
      /*@ assert \valid(*(argv + i)); */ ;
      {
        ...
        __gen_e_acsl_assert_data_6.pred_txt = "\\forall int k; 0 <= k <= len ==> \\valid(*(argv + i) + k)";
