  ...
  }
  {
    ...
    __e_acsl_full_init((void *)(& heap_pair));
    {
      ...
      /*@ assert E_ACSL: uninitialized: \initialized(&heap_pair); */
      {
        ...
        __gen_e_acsl_assert_data_9.pred_txt = "\\initialized(&heap_pair)";
    ...
    /*@ assert !\initialized(&heap_pair->a); */ ;
    {
      ...
      __e_acsl_assert_register_ptr(& __gen_e_acsl_assert_data_11,"heap_pair",
                                   (void *)heap_pair);
      ...
      /*@ assert E_ACSL: "pointer alignment": \aligned(heap_pair,4); */
      {
        ...
        __gen_e_acsl_assert_data_11.pred_txt = "\\aligned(heap_pair,4)";
    ...
    heap_pair->a = 3;
    {
      ...
      __e_acsl_assert_register_ptr(& __gen_e_acsl_assert_data_14,"heap_pair",
                                   (void *)heap_pair);
      ...
      /*@ assert E_ACSL: uninitialized: \initialized(&heap_pair); */
      {
        ...
        __gen_e_acsl_assert_data_15.pred_txt = "\\initialized(&heap_pair)";
    ...
    /*@ assert \initialized(&heap_pair->a); */ ;
    {
      ...
      __e_acsl_assert_register_ptr(& __gen_e_acsl_assert_data_17,"heap_pair",
                                   (void *)heap_pair);
      ...
      /*@ assert E_ACSL: "pointer alignment": \aligned(heap_pair,4); */
      {
        ...
        __gen_e_acsl_assert_data_17.pred_txt = "\\aligned(heap_pair,4)";
    ...
    heap_pair->b = 4;
    {
      ...
      __e_acsl_assert_register_ptr(& __gen_e_acsl_assert_data_20,"heap_pair",
                                   (void *)heap_pair);
      ...
      /*@ assert E_ACSL: "pointer alignment": \aligned(heap_pair,4); */
      {
        ...
        __gen_e_acsl_assert_data_20.pred_txt = "\\aligned(heap_pair,4)";
      ...
      /*@ assert E_ACSL: uninitialized: \initialized(&heap_pair); */
      {
        ...
        __gen_e_acsl_assert_data_21.pred_txt = "\\initialized(&heap_pair)";
    ...
    /*@ assert \initialized(&heap_pair->a); */ ;
    {
      ...
      __e_acsl_assert_register_ptr(& __gen_e_acsl_assert_data_23,"heap_pair",
                                   (void *)heap_pair);
      ...
      /*@ assert E_ACSL: "pointer alignment": \aligned(heap_pair,4); */
      {
        ...
        __gen_e_acsl_assert_data_23.pred_txt = "\\aligned(heap_pair,4)";
      ...
      /*@ assert E_ACSL: uninitialized: \initialized(&heap_pair); */
      {
        ...
        __gen_e_acsl_assert_data_24.pred_txt = "\\initialized(&heap_pair)";
