...
int main(int argc, char const **argv)
{
  ...
  free((void *)p);
  {
    ...
    __e_acsl_assert_register_int(& __gen_e_acsl_assert_data_4,"\\valid(p)",0,
  ...
  free((void *)a);
  {
    ...
    __e_acsl_assert_register_ulong(& __gen_e_acsl_assert_data_12,
                                   "sizeof(char)",0,sizeof(char));
    __e_acsl_assert_register_int(& __gen_e_acsl_assert_data_12,"\\valid(a)",
    ...
    __e_acsl_assert(! __gen_e_acsl_valid_4,& __gen_e_acsl_assert_data_12);
...
void *__gen_e_acsl_aligned_alloc(size_t alignment, size_t size)
{
  ...
  __retres = aligned_alloc(alignment,size);
  {
    ...
    if (__gen_e_acsl_assumes_value) {
      ...
      __e_acsl_assert_data_t __gen_e_acsl_assert_data_5 =
        {.values = (void *)0};
      __e_acsl_assert_register_int(& __gen_e_acsl_assert_data_5,"__fc_errno",
                                   0,errno);
      __e_acsl_assert_register_int(& __gen_e_acsl_assert_data_5,
                                   "\\old(__fc_errno)",0,__gen_e_acsl_at);
      __gen_e_acsl_assert_data_5.blocking = 1;
      __gen_e_acsl_assert_data_5.kind = "Postcondition";
      __gen_e_acsl_assert_data_5.pred_txt = "__fc_errno == \\old(__fc_errno)";
      __gen_e_acsl_assert_data_5.file = "FRAMAC_SHARE/libc/stdlib.h";
      __gen_e_acsl_assert_data_5.fct = "aligned_alloc";
      __gen_e_acsl_assert_data_5.line = 558;
      __gen_e_acsl_assert_data_5.name = "allocation/errno_same";
      __e_acsl_assert(errno == __gen_e_acsl_at,& __gen_e_acsl_assert_data_5);
      __e_acsl_assert_clean(& __gen_e_acsl_assert_data_5);
      __gen_e_acsl_assert_data_4.blocking = 1;
      __gen_e_acsl_assert_data_4.kind = "Postcondition";
      __gen_e_acsl_assert_data_4.pred_txt = "\\aligned(\\result,\\old(alignment))";
      __gen_e_acsl_assert_data_4.file = "FRAMAC_SHARE/libc/stdlib.h";
      __gen_e_acsl_assert_data_4.fct = "aligned_alloc";
      __gen_e_acsl_assert_data_4.line = 557;
      __gen_e_acsl_assert_data_4.name = "allocation/alignment";
    ...
    if (__gen_e_acsl_assumes_value) {
      ...
      __gen_e_acsl_assert_data_7.line = 567;
      __gen_e_acsl_assert_data_7.name = "no_allocation/errno_set";
      ...
      __gen_e_acsl_assert_data_6.line = 566;
      __gen_e_acsl_assert_data_6.name = "no_allocation/null_result";
      __e_acsl_assert(__retres == (void *)0,& __gen_e_acsl_assert_data_6);
      __e_acsl_assert_clean(& __gen_e_acsl_assert_data_6);
    }
    __gen_e_acsl_assumes_value = __e_acsl_contract_get_behavior_assumes
    ((__e_acsl_contract_t const *)__gen_e_acsl_contract,2UL);
    if (__gen_e_acsl_assumes_value) {
      ...
      __gen_e_acsl_assert_data_9.pred_txt = "__fc_errno == 22";
      __gen_e_acsl_assert_data_9.file = "FRAMAC_SHARE/libc/stdlib.h";
      __gen_e_acsl_assert_data_9.fct = "aligned_alloc";
      __gen_e_acsl_assert_data_9.line = 574;
      __gen_e_acsl_assert_data_9.name = "no_allocation_invalid_align/errno_set";
      __e_acsl_assert(errno == 22,& __gen_e_acsl_assert_data_9);
      __e_acsl_assert_clean(& __gen_e_acsl_assert_data_9);
      __gen_e_acsl_assert_data_8.blocking = 1;
      ...
      __gen_e_acsl_assert_data_8.line = 573;
      __gen_e_acsl_assert_data_8.name = "no_allocation_invalid_align/null_result";
