...
void *__gen_e_acsl_aligned_alloc(size_t alignment, size_t size)
{
  ...
  __e_acsl_store_block((void *)(& __retres),8UL);
  {
    ...
    __e_acsl_assert_data_t __gen_e_acsl_assert_data_5 =
      {.values = (void *)0};
    __e_acsl_assert_register_ulong(& __gen_e_acsl_assert_data_5,"alignment",
                                   0,alignment);
    __gen_e_acsl_assert_data_5.blocking = 1;
    __gen_e_acsl_assert_data_5.kind = "RTE";
    __gen_e_acsl_assert_data_5.pred_txt = "alignment != 0";
    __gen_e_acsl_assert_data_5.file = "FRAMAC_SHARE/libc/stdlib.h";
    __gen_e_acsl_assert_data_5.fct = "aligned_alloc";
    __gen_e_acsl_assert_data_5.line = 541;
    __gen_e_acsl_assert_data_5.name = "division_by_zero";
    __e_acsl_assert(alignment != 0UL,& __gen_e_acsl_assert_data_5);
    __e_acsl_assert_clean(& __gen_e_acsl_assert_data_5);
  ...
  __retres = aligned_alloc(alignment,size);
  {
    ...
    if (__gen_e_acsl_assumes_value) {
      ...
      __gen_e_acsl_assert_data_9.pred_txt = "__fc_errno == \\old(__fc_errno)";
      __gen_e_acsl_assert_data_9.file = "FRAMAC_SHARE/libc/stdlib.h";
      __gen_e_acsl_assert_data_9.fct = "aligned_alloc";
      __gen_e_acsl_assert_data_9.line = 558;
      __gen_e_acsl_assert_data_9.name = "allocation/errno_same";
      __e_acsl_assert(errno == __gen_e_acsl_at,& __gen_e_acsl_assert_data_9);
      __e_acsl_assert_clean(& __gen_e_acsl_assert_data_9);
      __gen_e_acsl_assert_data_7.blocking = 1;
      __gen_e_acsl_assert_data_7.kind = "Postcondition";
      __gen_e_acsl_assert_data_7.pred_txt = "\\aligned(\\result,\\old(alignment))";
      ...
      __gen_e_acsl_assert_data_7.name = "allocation/alignment";
    ...
    if (__gen_e_acsl_assumes_value) {
      ...
      __gen_e_acsl_assert_data_11.pred_txt = "__fc_errno == 12";
      __gen_e_acsl_assert_data_11.file = "FRAMAC_SHARE/libc/stdlib.h";
      __gen_e_acsl_assert_data_11.fct = "aligned_alloc";
      __gen_e_acsl_assert_data_11.line = 567;
      __gen_e_acsl_assert_data_11.name = "no_allocation/errno_set";
      __e_acsl_assert(errno == 12,& __gen_e_acsl_assert_data_11);
      __e_acsl_assert_clean(& __gen_e_acsl_assert_data_11);
      __gen_e_acsl_assert_data_10.blocking = 1;
      ...
      __gen_e_acsl_assert_data_10.line = 566;
      __gen_e_acsl_assert_data_10.name = "no_allocation/null_result";
    ...
    if (__gen_e_acsl_assumes_value) {
      ...
      __gen_e_acsl_assert_data_13.pred_txt = "__fc_errno == 22";
      __gen_e_acsl_assert_data_13.file = "FRAMAC_SHARE/libc/stdlib.h";
      __gen_e_acsl_assert_data_13.fct = "aligned_alloc";
      __gen_e_acsl_assert_data_13.line = 574;
      __gen_e_acsl_assert_data_13.name = "no_allocation_invalid_align/errno_set";
      __e_acsl_assert(errno == 22,& __gen_e_acsl_assert_data_13);
      __e_acsl_assert_clean(& __gen_e_acsl_assert_data_13);
      __gen_e_acsl_assert_data_12.blocking = 1;
      __gen_e_acsl_assert_data_12.kind = "Postcondition";
      __gen_e_acsl_assert_data_12.pred_txt = "\\result == \\null";
      __gen_e_acsl_assert_data_12.file = "FRAMAC_SHARE/libc/stdlib.h";
      __gen_e_acsl_assert_data_12.fct = "aligned_alloc";
      __gen_e_acsl_assert_data_12.line = 573;
      __gen_e_acsl_assert_data_12.name = "no_allocation_invalid_align/null_result";
      __e_acsl_assert(__retres == (void *)0,& __gen_e_acsl_assert_data_12);
      __e_acsl_assert_clean(& __gen_e_acsl_assert_data_12);
    }
    __e_acsl_contract_clean(__gen_e_acsl_contract);
    __e_acsl_delete_block((void *)(& size));
