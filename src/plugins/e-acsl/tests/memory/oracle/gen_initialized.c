...
int main(void)
{
  ...
  q = & b;
  {
    ...
    __gen_e_acsl_assert_data_5.line = 34;
  ...
  r = d;
  {
    ...
    __gen_e_acsl_initialized_11 = __e_acsl_initialized((void *)(d),
                                                       sizeof(long));
    __e_acsl_assert_register_ptr(& __gen_e_acsl_assert_data_13,"&(d[0])",
                                 (void *)(d));
    ...
    __gen_e_acsl_assert_data_13.pred_txt = "!\\initialized(&(d[0]))";
  ...
  /*@ assert \initialized(&(d[0])); */ ;
  {
    ...
    __gen_e_acsl_assert_data_19.line = 55;
  ...
  /*@ assert !\initialized(&d); */ ;
  {
    ...
    __gen_e_acsl_assert_data_21.line = 57;
  ...
  /*@ assert \initialized(r); */ ;
  {
    ...
    __gen_e_acsl_assert_data_22.line = 58;
  ...
  d[1] = 1L;
  {
    ...
    __gen_e_acsl_assert_data_23.line = 61;
  ...
  /*@ assert \initialized(&d); */ ;
  {
    ...
    __gen_e_acsl_assert_data_26.line = 64;
  ...
  /*@ assert \initialized(r); */ ;
  {
    ...
    __gen_e_acsl_assert_data_27.line = 65;
  ...
  p = (int *)malloc(8UL);
  {
    ...
    __gen_e_acsl_assert_data_28.line = 69;
  ...
  q = (int *)realloc((void *)q,8UL);
  {
    ...
    __gen_e_acsl_assert_data_30.line = 78;
  ...
  q ++;
  {
    ...
    __gen_e_acsl_assert_data_31.line = 80;
  ...
  free((void *)q);
  {
    ...
    __gen_e_acsl_assert_data_32.line = 88;
  ...
  /*@ assert !\initialized(p); */ ;
  {
    ...
    __gen_e_acsl_assert_data_33.line = 89;
  ...
  q = (int *)calloc(3UL,4UL);
  {
    ...
    __gen_e_acsl_assert_data_34.line = 94;
  ...
  q = (int *)realloc((void *)q,24UL);
  {
    ...
    __gen_e_acsl_assert_data_35.line = 96;
  ...
  /*@ assert !\initialized(q + 3); */ ;
  {
    ...
    __gen_e_acsl_assert_data_37.line = 98;
  ...
  /*@ assert !\initialized(q + 4); */ ;
  {
    ...
    __gen_e_acsl_assert_data_38.line = 99;
  ...
  q = (int *)calloc(7UL,4UL);
  {
    ...
    __gen_e_acsl_assert_data_39.line = 102;
  ...
  q = (int *)realloc((void *)q,32UL);
  {
    ...
    __gen_e_acsl_assert_data_40.line = 104;
  ...
  /*@ assert \initialized(q + (0 .. 6)); */ ;
  {
    ...
    __gen_e_acsl_assert_data_41.line = 105;
  ...
  q = (int *)realloc((void *)q,40UL);
  {
    ...
    __gen_e_acsl_assert_data_42.line = 107;
  ...
  /*@ assert \initialized(q + (0 .. 6)); */ ;
  {
    ...
    __gen_e_acsl_assert_data_43.line = 108;
  ...
  /*@ assert !\initialized(q + 7); */ ;
  {
    ...
    __gen_e_acsl_assert_data_44.line = 109;
  ...
  /*@ assert !\initialized(q + 8); */ ;
  {
    ...
    __gen_e_acsl_assert_data_45.line = 110;
  ...
  q = (int *)calloc(2UL,4UL);
  {
    ...
    __gen_e_acsl_assert_data_46.line = 113;
  ...
  q = (int *)realloc((void *)q,16UL);
  {
    ...
    __gen_e_acsl_assert_data_47.line = 115;
  ...
  /*@ assert \initialized(q + (0 .. 1)); */ ;
  {
    ...
    __gen_e_acsl_assert_data_48.line = 116;
  ...
  /*@ assert !\initialized(q + 2); */ ;
  {
    ...
    __gen_e_acsl_assert_data_49.line = 117;
  ...
  q = (int *)calloc(6UL,4UL);
  {
    ...
    __gen_e_acsl_assert_data_50.line = 120;
  ...
  q = (int *)malloc(24UL);
  {
    ...
    __gen_e_acsl_assert_data_52.line = 125;
  ...
  /*@ assert !\initialized(q + 1); */ ;
  {
    ...
    __gen_e_acsl_assert_data_54.line = 127;
  ...
  /*@ assert !\initialized(q + 2); */ ;
  {
    ...
    __gen_e_acsl_assert_data_55.line = 128;
  ...
  /*@ assert !\initialized(q + 4); */ ;
  {
    ...
    __gen_e_acsl_assert_data_57.line = 130;
  ...
  q = (int *)realloc((void *)q,12UL);
  {
    ...
    __gen_e_acsl_assert_data_58.line = 132;
  ...
  /*@ assert !\initialized(q + 0); */ ;
  {
    ...
    __gen_e_acsl_assert_data_59.line = 133;
  ...
  /*@ assert !\initialized(q + 1); */ ;
  {
    ...
    __gen_e_acsl_assert_data_60.line = 134;
  ...
  p = (int *)0;
  {
    ...
    __gen_e_acsl_assert_data_62.line = 146;
  ...
  __e_acsl_full_init((void *)(& t_1));
  {
    ...
    __e_acsl_assert_register_ptr(& __gen_e_acsl_assert_data_63,"&(t_1[0])",
                                 (void *)(t_1));
    ...
    __gen_e_acsl_assert_data_63.pred_txt = "\\initialized(&t_1[0 .. 2])";
    __gen_e_acsl_assert_data_63.file = "initialized.c";
    __gen_e_acsl_assert_data_63.fct = "main";
    __gen_e_acsl_assert_data_63.line = 179;
  ...
  s.t[2] = 3;
  {
    ...
    __e_acsl_assert_register_ptr(& __gen_e_acsl_assert_data_64,"&(s[0])",
                                 (void *)(& s));
    __e_acsl_assert_register_int(& __gen_e_acsl_assert_data_64,"sizeof(int)",
                                 0,4);
    ...
    __gen_e_acsl_assert_data_64.pred_txt = "\\initialized(&s.t[0 .. 2])";
    __gen_e_acsl_assert_data_64.file = "initialized.c";
    __gen_e_acsl_assert_data_64.fct = "main";
    __gen_e_acsl_assert_data_64.line = 185;
  ...
  __e_acsl_full_init((void *)(& t_p));
  {
    ...
    __gen_e_acsl_assert_data_65.pred_txt = "\\initialized(&(*((int (*)[3])t_p))[0 .. 2])";
    __gen_e_acsl_assert_data_65.file = "initialized.c";
    __gen_e_acsl_assert_data_65.fct = "main";
    __gen_e_acsl_assert_data_65.line = 188;
