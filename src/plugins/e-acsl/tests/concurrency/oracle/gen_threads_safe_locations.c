...
void *thread_start(void *arg)
{
  ...
  /*@ assert \valid(__fc_stderr) && \initialized(__fc_stderr); */ ;
  {
    ...
    if (__gen_e_acsl_valid_3) {
      ...
      __gen_e_acsl_and_3 = __gen_e_acsl_initialized_3;
    }
  ...
  __e_acsl_full_init((void *)(& addrof_errno));
  {
    ...
    if (__gen_e_acsl_and_4) {
      ...
      __gen_e_acsl_and_5 = __gen_e_acsl_initialized_5;
    }
    ...
    __e_acsl_assert(__gen_e_acsl_and_5,& __gen_e_acsl_assert_data_4);
