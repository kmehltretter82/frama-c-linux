...
int __gen_e_acsl_pthread_mutex_unlock(pthread_mutex_t *mutex)
{
  ...
  __e_acsl_store_block((void *)(& __retres),4UL);
  {
    ...
    __gen_e_acsl_assert_data.line = 505;
  ...
  __retres = pthread_mutex_unlock(mutex);
  {
    ...
    __gen_e_acsl_assert_data_2.line = 508;
...
int __gen_e_acsl_pthread_mutex_lock(pthread_mutex_t *mutex)
{
  ...
  __retres = pthread_mutex_lock(mutex);
  {
    ...
    __gen_e_acsl_assert_data_2.line = 477;
    __gen_e_acsl_assert_data_2.name = "success_or_error";
                                    ...
                                    pthread_mutexattr_t const * restrict attrs)
{
  ...
  __e_acsl_store_block((void *)(& __retres),4UL);
  {
    ...
    __gen_e_acsl_assert_data.line = 457;
    __gen_e_acsl_assert_data.name = "mutex_valid";
    __e_acsl_assert(__gen_e_acsl_valid,& __gen_e_acsl_assert_data);
    __e_acsl_assert_clean(& __gen_e_acsl_assert_data);
    __e_acsl_assert_data_t __gen_e_acsl_assert_data_2 =
    ...
    __gen_e_acsl_assert_data_2.line = 458;
                                   ...
                                   pthread_mutex_t * restrict mutex)
{
  ...
  __e_acsl_store_block((void *)(& __retres),4UL);
  {
    ...
    __gen_e_acsl_assert_data.line = 323;
    ...
    __gen_e_acsl_assert_data_2.line = 324;
  ...
  __retres = pthread_cond_wait(cond,mutex);
  {
    ...
    __gen_e_acsl_assert_data_3.line = 326;
                                   ...
                                   pthread_condattr_t const * restrict attr)
{
  ...
  __e_acsl_store_block((void *)(& __retres),4UL);
  {
    ...
    __gen_e_acsl_assert_data.line = 300;
    __gen_e_acsl_assert_data.name = "valid_cond";
    __e_acsl_assert(__gen_e_acsl_valid,& __gen_e_acsl_assert_data);
    __e_acsl_assert_clean(& __gen_e_acsl_assert_data);
    __e_acsl_assert_data_t __gen_e_acsl_assert_data_2 =
    ...
    __gen_e_acsl_assert_data_2.line = 301;
    __gen_e_acsl_assert_data_2.name = "valid_null_attr";
    __e_acsl_assert(__gen_e_acsl_or,& __gen_e_acsl_assert_data_2);
    __e_acsl_assert_clean(& __gen_e_acsl_assert_data_2);
  }
  __retres = pthread_cond_init(cond,attr);
  {
    ...
    __gen_e_acsl_assert_data_3.line = 304;
    ...
    __gen_e_acsl_assert_data_4.line = 305;
...
int __gen_e_acsl_pthread_cond_broadcast(pthread_cond_t *cond)
{
  ...
  __retres = pthread_cond_broadcast(cond);
  {
    ...
    __gen_e_acsl_assert_data_2.line = 288;
...
void __e_acsl_globals_init(void)
{
  ...
  if (! __e_acsl_already_run) {
    ...
    __e_acsl_store_block((void *)(__fc_getpass),16UL);
    __e_acsl_full_init((void *)(& __fc_getpass));
    __e_acsl_store_block((void *)(& __fc_p_getlogin),8UL);
    __e_acsl_full_init((void *)(& __fc_p_getlogin));
    __e_acsl_store_block((void *)(__fc_getlogin),8UL);
    __e_acsl_full_init((void *)(& __fc_getlogin));
    __e_acsl_store_block((void *)(& __fc_p_crypt),8UL);
    __e_acsl_full_init((void *)(& __fc_p_crypt));
    __e_acsl_store_block((void *)(__fc_crypt),256UL);
    __e_acsl_full_init((void *)(& __fc_crypt));
...
void __e_acsl_globals_clean(void)
{
  ...
  __e_acsl_delete_block((void *)(__fc_getpass));
  __e_acsl_delete_block((void *)(& __fc_p_getlogin));
  __e_acsl_delete_block((void *)(__fc_getlogin));
  __e_acsl_delete_block((void *)(& __fc_p_crypt));
  __e_acsl_delete_block((void *)(__fc_crypt));
