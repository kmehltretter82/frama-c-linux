...
void f_signed(int a, int b)
{
  ...
  int d = b >> 2;
  {
    ...
    __e_acsl_assert_register_int(& __gen_e_acsl_assert_data_2,"b",0,b);
    ...
    __e_acsl_assert(d == b >> 2,& __gen_e_acsl_assert_data_2);
  ...
  int e = a | b;
  {
    __e_acsl_assert_data_t __gen_e_acsl_assert_data_3 =
      {.values = (void *)0};
    __e_acsl_assert_register_int(& __gen_e_acsl_assert_data_3,"e",0,e);
    ...
    __e_acsl_assert((long)e == (a | (long)b),& __gen_e_acsl_assert_data_3);
  ...
  int f = a & b;
  {
    __e_acsl_assert_data_t __gen_e_acsl_assert_data_4 =
      {.values = (void *)0};
    __e_acsl_assert_register_int(& __gen_e_acsl_assert_data_4,"f",0,f);
    ...
    __e_acsl_assert((long)f == (a & (long)b),& __gen_e_acsl_assert_data_4);
  ...
  int g = a ^ b;
  {
    ...
    __e_acsl_assert((long)g == (a ^ (long)b),& __gen_e_acsl_assert_data_5);
