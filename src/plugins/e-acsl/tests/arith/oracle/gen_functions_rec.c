...
int main(void)
{
  ...
  /*@ assert f2(7) == 1; */ ;
  {
    ...
    __gen_e_acsl_assert_data_11.pred_txt = "f3(6) == -5";
    ...
    __e_acsl_assert(__gen_e_acsl_f3_8 == -5,& __gen_e_acsl_assert_data_11);
  }
  /*@ assert f3(6) == -5; */ ;
  {
    ...
    __gen_e_acsl_assert_data_12.pred_txt = "f4(9) > 0";
    __gen_e_acsl_assert_data_12.file = "tests/arith/functions_rec.c";
    __gen_e_acsl_assert_data_12.fct = "main";
    __gen_e_acsl_assert_data_12.line = 36;
    __e_acsl_assert(__gen_e_acsl_f4_8 > 0UL,& __gen_e_acsl_assert_data_12);
  }
  /*@ assert f4(9) > 0; */ ;
  {
    ...
    __gen_e_acsl_assert_data_13.pred_txt = "f5(0) == 0";
    __gen_e_acsl_assert_data_13.file = "tests/arith/functions_rec.c";
    __gen_e_acsl_assert_data_13.fct = "main";
    __gen_e_acsl_assert_data_13.line = 38;
    __e_acsl_assert(__gen_e_acsl_eq_4 == 0,& __gen_e_acsl_assert_data_13);
  ...
  /*@ assert f5(0) == 0; */ ;
  {
    ...
    __gen_e_acsl_assert_data_14.pred_txt = "\\let n = 0 == 0? 0x7fffffffffffffffL: -1; f5(n) == 0";
    __gen_e_acsl_assert_data_14.file = "tests/arith/functions_rec.c";
    __gen_e_acsl_assert_data_14.fct = "main";
    __gen_e_acsl_assert_data_14.line = 40;
    __e_acsl_assert(__gen_e_acsl_eq_5 == 0,& __gen_e_acsl_assert_data_14);
...
int __gen_e_acsl_f2(int n)
{
  ...
  if (n < 0) __gen_e_acsl_if_6 = 1;
    ...
    __gen_e_acsl_assert_data_10.pred_txt = "division_by_zero: __gen_e_acsl_f2_19 != 0";
    __gen_e_acsl_assert_data_10.file = "tests/arith/functions_rec.c";
    __gen_e_acsl_assert_data_10.fct = "f2";
    __gen_e_acsl_assert_data_10.line = 13;
    __e_acsl_assert(__gen_e_acsl_f2_19 != 0,& __gen_e_acsl_assert_data_10);
...
int __gen_e_acsl_f2_2(long n)
{
  ...
  if (n < 0L) __gen_e_acsl_if_5 = 1;
    ...
    */
    ...
    __gen_e_acsl_assert_data_8.pred_txt = "division_by_zero: __gen_e_acsl_f2_14 != 0";
    __gen_e_acsl_assert_data_8.file = "tests/arith/functions_rec.c";
    __gen_e_acsl_assert_data_8.fct = "f2_2";
    __gen_e_acsl_assert_data_8.line = 13;
    __e_acsl_assert(__gen_e_acsl_f2_14 != 0,& __gen_e_acsl_assert_data_8);
...
int __gen_e_acsl_f2_3(__e_acsl_mpz_struct * n)
{
  ...
  if (__gen_e_acsl_lt < 0) __gen_e_acsl_if_4 = 1;
    ...
    */
    ...
    __gen_e_acsl_assert_data_6.pred_txt = "division_by_zero: __gen_e_acsl_f2_9 != 0";
    __gen_e_acsl_assert_data_6.file = "tests/arith/functions_rec.c";
    __gen_e_acsl_assert_data_6.fct = "f2_3";
    __gen_e_acsl_assert_data_6.line = 13;
    __e_acsl_assert(__gen_e_acsl_f2_9 != 0,& __gen_e_acsl_assert_data_6);
