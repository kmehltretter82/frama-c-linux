...
int main(void)
{
  ...
  /*@ assert (0 != 0) == !(1 != 0); */ ;
  {
    ...
    __e_acsl_assert(__gen_e_acsl_eq_9 == 0,& __gen_e_acsl_assert_data_18);
  ...
  /*@ assert 4 / y == 2; */ ;
  {
    ...
    __gmpz_init_set_ui(__gen_e_acsl__21,123456789123456789UL);
    ...
    __e_acsl_assert(__gen_e_acsl_eq_10 == 0,& __gen_e_acsl_assert_data_19);
  ...
  short b = (short)1;
  {
    ...
    __gmpq_set_d(__gen_e_acsl__25,2.);
    __gmpq_init(__gen_e_acsl__26);
    __gmpq_set_d(__gen_e_acsl__26,1.);
    ...
    __e_acsl_assert_register_short(& __gen_e_acsl_assert_data_21,"a",0,a);
    __e_acsl_assert_register_short(& __gen_e_acsl_assert_data_21,"b",0,b);
    __gen_e_acsl_assert_data_21.blocking = 1;
    __gen_e_acsl_assert_data_21.kind = "Assertion";
    __gen_e_acsl_assert_data_21.pred_txt = "a + b > 2. - 1.";
    __gen_e_acsl_assert_data_21.file = "arith.i";
    __gen_e_acsl_assert_data_21.fct = "main";
    __gen_e_acsl_assert_data_21.line = 39;
    __e_acsl_assert(__gen_e_acsl_gt > 0,& __gen_e_acsl_assert_data_21);
