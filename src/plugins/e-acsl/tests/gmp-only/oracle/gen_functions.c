 ...
 */
char __gen_e_acsl_h_char(__e_acsl_mpz_struct * c);

/*@ logic short h_short(short s) = s;
 */
short __gen_e_acsl_h_short(__e_acsl_mpz_struct * s);

/*@ logic int g_hidden(int x) = x;
 */
int __gen_e_acsl_g_hidden(__e_acsl_mpz_struct * x);

/*@ logic int g(int x) = g_hidden(x);
 */
int __gen_e_acsl_g(__e_acsl_mpz_struct * x);
 ...
 */
double __gen_e_acsl_f2(__e_acsl_mpq_struct * x);
...
int main(void)
{
  ...
  int y = 2;
  {
    ...
    __gen_e_acsl_p1_2 = __gen_e_acsl_p1((__e_acsl_mpz_struct *)x,
                                        (__e_acsl_mpz_struct *)y);
  ...
  /*@ assert p1(x, y); */ ;
  {
    ...
    __e_acsl_assert_data_t __gen_e_acsl_assert_data_2 =
      {.values = (void *)0};
    __gen_e_acsl_p2_2 = __gen_e_acsl_p2((__e_acsl_mpz_struct *)3,
                                        (__e_acsl_mpz_struct *)4);
  ...
  /*@ assert p2(3, 4); */ ;
  {
    ...
    __gen_e_acsl_p2_4 = __gen_e_acsl_p2_3((__e_acsl_mpz_struct *)5,
  ...
  /*@ assert p2(5, 99999999999999999999999999999); */ ;
  {
    ...
    __e_acsl_assert_data_t __gen_e_acsl_assert_data_4 =
      {.values = (void *)0};
    __gen_e_acsl_f1(& __gen_e_acsl_f1_2,(__e_acsl_mpz_struct *)x,
                    (__e_acsl_mpz_struct *)y);
  ...
  /*@ assert f1(x, y) == 3; */ ;
  {
    ...
    */
    __gen_e_acsl_p2_6 = __gen_e_acsl_p2_5((__e_acsl_mpz_struct *)x,
  ...
  ;
  {
    ...
    __e_acsl_assert_data_t __gen_e_acsl_assert_data_8 =
      {.values = (void *)0};
    __gen_e_acsl_g_2 = __gen_e_acsl_g((__e_acsl_mpz_struct *)x);
  ...
  char c = (char)'c';
  {
    ...
    __e_acsl_assert_data_t __gen_e_acsl_assert_data_9 =
      {.values = (void *)0};
    __gen_e_acsl_h_char_2 = __gen_e_acsl_h_char((__e_acsl_mpz_struct *)c);
  ...
  short s = (short)1;
  {
    ...
    __e_acsl_assert_data_t __gen_e_acsl_assert_data_10 =
      {.values = (void *)0};
    __gen_e_acsl_h_short_2 = __gen_e_acsl_h_short((__e_acsl_mpz_struct *)s);
  ...
  m.l = 9;
  {
    ...
    __gmpz_init_set_si(__gen_e_acsl__17,17L);
  ...
  double d = 2.0;
  {
    ...
    __e_acsl_mpq_t __gen_e_acsl_app_4;
    __e_acsl_mpq_t __gen_e_acsl__19;
    int __gen_e_acsl_gt_6;
    __e_acsl_assert_data_t __gen_e_acsl_assert_data_12 =
      {.values = (void *)0};
    __gen_e_acsl_f2_2 = __gen_e_acsl_f2((__e_acsl_mpq_struct *)d);
    __gmpq_init(__gen_e_acsl_app_4);
    __gmpq_set_d(__gen_e_acsl_app_4,__gen_e_acsl_f2_2);
    __gmpq_init(__gen_e_acsl__19);
    __gmpq_set_str(__gen_e_acsl__19,"0",10);
    __gen_e_acsl_gt_6 = __gmpq_cmp((__e_acsl_mpq_struct const *)(__gen_e_acsl_app_4),
    ...
    __gmpq_clear(__gen_e_acsl_app_4);
...
{
  {
    ...
    __e_acsl_assert_data_t __gen_e_acsl_assert_data = {.values = (void *)0};
    __gen_e_acsl_k_pred_2 = __gen_e_acsl_k_pred((__e_acsl_mpz_struct *)x);
    __e_acsl_assert_register_int(& __gen_e_acsl_assert_data,"x",0,x);
...
/*@ assigns \result;
    assigns \result \from *((__e_acsl_mpz_struct *)c); */
char __gen_e_acsl_h_char(__e_acsl_mpz_struct * c)
{
  return c;
}
...
/*@ assigns \result;
    assigns \result \from *((__e_acsl_mpz_struct *)s); */
short __gen_e_acsl_h_short(__e_acsl_mpz_struct * s)
{
  return s;
}
...
int __gen_e_acsl_g(__e_acsl_mpz_struct * x)
{
  ...
  __gen_e_acsl__14 = __gmpz_get_si((__e_acsl_mpz_struct const *)(x));
  __gen_e_acsl_g_hidden_2 = __gen_e_acsl_g_hidden((__e_acsl_mpz_struct *)__gen_e_acsl__14);
...
void __gen_e_acsl_t2(__e_acsl_mpz_t *__retres_arg, mystruct m)
{
  ...
  __gmpz_init_set_si(__gen_e_acsl__15,(long)m.k);
  __gmpz_init_set_si(__gen_e_acsl__16,(long)m.l);
...
double __gen_e_acsl_f2(__e_acsl_mpq_struct * x)
{
  ...
  __gmpq_set_str(__gen_e_acsl__18,"1",10);
