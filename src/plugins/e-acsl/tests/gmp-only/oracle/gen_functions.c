...
int __gen_e_acsl_p2_5(int x, __e_acsl_mpz_struct * y);
...
int main(void)
{
  ...
  /*@ assert f1(x, y) == 3; */ ;
  {
    ...
    */
    __gen_e_acsl_p2_6 = __gen_e_acsl_p2_5(x,
