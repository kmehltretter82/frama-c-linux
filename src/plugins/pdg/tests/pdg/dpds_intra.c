...
*/
/* bin/toplevel.opt -deps -main g src/plugins/slicing/tests/slicing/dpds_intra.c */
/* bin/toplevel.opt -fct-pdg test_goto_simple src/plugins/slicing/tests/slicing/dpds_intra.c -pdg-dot */
...
./bin/toplevel.opt  -eva -main test_ctrl_dpd_multiple src/plugins/slicing/tests/slicing/dpds_intra.c
