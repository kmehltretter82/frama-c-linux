...
* To try it, use the following commands :
  ...
  make src/plugins/slicing/tests/slicing/merge.byte; \
  src/plugins/slicing/tests/slicing/merge.byte -deps -lib-entry g -slicing-level 3 \
                          src/plugins/slicing/tests/slicing/merge.c
*)
