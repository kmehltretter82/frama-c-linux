...
\emph{Introduced since Frama-C 33.0 (Arsenic)}

\textsf{WP} automatically detects available provers from \verb+$PATH+. It
also uses any prover configured from the default \textsf{Why3} configuration
or any additional configuration provided by the user (see options).
