...
The proof obligations generated by \textsf{WP} do not entail
systematic termination, unless you systematically specify and validate
loop variant \textsf{ACSL} annotations. Nevertheless, \texttt{exit} behaviors of a
function are correctly handled by \textsf{WP}.
