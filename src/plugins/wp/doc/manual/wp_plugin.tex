...
To activate counter examples generation by \textsf{WP} you shall use
...
Notice that cache usage is deactivated for provers asked to generate a
...
proof transformer (\textsf{TIP}) also display models in the graphical user
...
\begin{description}
\item[\tt -wp-(no)-counter-examples] activates counter examples generation for
