...
[@@deprecated "Use Ast_types.Acsl.direct_pointed_ctype instead"]
[@@migrate { repl = Ast_types.Acsl.direct_pointed_ctype }]

val ctype_of_array_elem: logic_type -> typ
[@@deprecated "Use Ast_types.Acsl.direct_array_element_ctype instead"]
[@@migrate { repl = Ast_types.Acsl.direct_array_element_ctype }]
