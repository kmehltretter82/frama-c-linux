...
to the test directory.
  ...
  [kernel:mopsa-db:non-c-source] Warning: 
    ignoring non-C (C++) dependency: Tests/UnitTests/CMakeFiles/UnitTests.dir/TestTable.cpp.o
    (setting this warning category to inactive or feedback will try to parse it nevertheless)
  [kernel:mopsa-db:non-c-source] Warning: 
    ignoring non-C (C++) dependency: Tests/UnitTests/CMakeFiles/UnitTests.dir/Main.cpp.o
    (setting this warning category to inactive or feedback will try to parse it nevertheless)
