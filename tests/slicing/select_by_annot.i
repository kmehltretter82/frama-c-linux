/* run.config
   ...
   CMD: frama-c @FRAMA_C_DEFAULT_OPTIONS@ -load-plugin slicing -load-module %{dep:libSelect.cmxs} -load-module %{dep:@PTEST_NAME@.cmxs}
   OPT: @EVA_OPTIONS@ -deps -lib-entry -main main -journal-disable
   CMD: frama-c @FRAMA_C_DEFAULT_OPTIONS@
