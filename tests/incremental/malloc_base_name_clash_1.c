/* run.config
  ...
  STDOPT: +"%{dep:malloc_base_name_clash_2.c} -eva -eva-load %{dep:@PTEST_NAME@.sav} -eva-no-alloc-returns-null -eva-mlevel 2 -eva-msg-key=alloc-summary,malloc,memexec,memexec-malloc,callstack @EVA_OPTIONS@"
*/
#include <stdlib.h>
