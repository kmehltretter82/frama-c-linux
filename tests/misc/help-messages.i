/* run.config
   ...
   PLUGIN: eva
   STDOPT: +"-eva-help-options"
   COMMENT: This tests the help message generated by Frama-C for Eva
   COMMENT: The output of -eva-h is different and tested in
   COMMENT: plugins/eva/tests/utils/help-messages.t
