/* run.config*
   STDOPT: +" -val-warn-copy-indeterminate=-cast_address -val -out -input -deps -calldeps -value-msg-key initial-state -absolute-valid-range 100-200 -inout -then -lib-entry"
 */
#include "string.h"
struct s;
//@ assigns *p \from \nothing;
