/* run.config*
   OPT: -no-autoload-plugins -load-module inout,eva -eva @EVA_OPTIONS@ -lib-entry -eva-initialization-padding-globals yes -then -eva-initialization-padding-globals no
*/
