/* run.config*
   OPT: -no-autoload-plugins -load-module eva,inout -eva @EVA_OPTIONS@ -cpp-extra-args="-DPTEST"  -journal-disable
   OPT: -no-autoload-plugins -load-module eva,inout -machdep ppc_32 -eva @EVA_OPTIONS@ -cpp-extra-args="-DPTEST" -journal-disable
*/
