...
void c11_6_2_8_1(void) // _Alignas cannot specify a weaker alignment
// + c11_6_2_8_2       // _Alignas(n) with n <= _Alignof(max_align_t) always allowed
{
  ...
  struct Al4 _Alignas(4) al8_2;
  struct Al4 _Alignas(8) al8_3;
  struct Al4 _Alignas(16) al8_4;

#ifdef ALIGNAS_WEAKER
  short _Alignas(1) s1;

  int _Alignas(1) i1;
  int _Alignas(2) i2;

  long int _Alignas(1) li1;
  long int _Alignas(2) li2;

  float _Alignas(1) f1;

  double _Alignas(1) d1;

  struct Al4 _Alignas(1) al8_1;
...
// c11_6_2_8_5: an address that satisfies an alignment satisfies the weaker ones
// --> not a typing property

// c11_6_2_8_6: see alignof_typing_constrains.c

// c11_6_2_8_7: comparing alignment is comparing their numeric values
// --> not a typing property

void c11_6_7_5_1(void)
...
void c11_6_7_5_2_c(int x) _Alignas(8)
{
}
#endif

#ifdef ALIGNAS_FUNCTION_2
_Alignas(8) void c11_6_7_5_2_c(int x)
{
}
#endif
...
void c11_6_7_5_2_d(int _Alignas(8) formal)
{
}
#endif

#ifdef ALIGNAS_REGISTER
void c11_6_7_5_2_e(void){
  register int _Alignas(8) v ;
}
#endif

// c11_6_7_5_3: _Alignas accepts valid or extended alingment.
// --> cf c11_6_2_8_3/4 above

// c11_6_7_5_4

// c11_6_7_5_5: _Alignas(typ) == _Alignas(_Alignof(typ))
