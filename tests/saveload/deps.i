/* run.config
   ...
   EXECNOW: LOG deps_sav.res LOG deps_sav.err BIN @PTEST_NAME@.sav @frama-c@ -load-module %{dep:deps_A.cmxs} -eva @EVA_OPTIONS@ -out -input -deps @PTEST_NAME@.i -save @PTEST_NAME@.sav > deps_sav.res 2> deps_sav.err
