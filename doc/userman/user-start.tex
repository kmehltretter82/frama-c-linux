...
this library.
It can be changed by setting the environment variable \textttdef{FRAMAC\_LIB}.
...
It can be changed by setting the environment variable \textttdef{FRAMAC\_SHARE}.
