...
\begin{longtable}{m{0.42\textwidth} m{0.53\textwidth}}
  ...
  \texttt{-warn-unaligned-pointer} & Toggles reporting of UBs {\em CC.24}. \\
  \texttt{-warn-left-shift-negative} & Toggles reporting of UB {\em CC.52}. \\
  \texttt{-warn-pointer-downcast} & Toggles reporting of UB {\em CC.23}. \\
...
\begin{longtable}{>{\raggedright}m{0.20\textwidth} >{\raggedright\arraybackslash}m{0.26\textwidth} >{\raggedright\arraybackslash}m{0.46\textwidth}}
  ...
  overflow & {\em CC.23}, {\em CC.36}, {\em CC.50} &
  ...
  \texttt{pointer\_downcast} (related to {\em CC.23}).
...
\begin{longtable}{>{\raggedright}m{0.42\textwidth} m{0.13\textwidth} >{\raggedright\arraybackslash}m{0.45\textwidth}}
  ...
  \CWE{685}: Function Call With Incorrect Number of Arguments & Partially Handled & \texttt{-variadic-translation} handles most cases related to variadic function calls\\
  \CWE{688}: Function Call With Incorrect Variable or Reference as Argument & Partially Handled & Some cases are related to variadic functions (e.g. \texttt{printf}) and detected by \texttt{-variadic-translation}\\
