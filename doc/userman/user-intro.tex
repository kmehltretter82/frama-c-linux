...
\item[Chapter~\ref{user-variadic}] presents the Variadic Translation component,
  used to help plug-ins handle code containing variadic
  functions, such as \texttt{printf} and \texttt{scanf}.
