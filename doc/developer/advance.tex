...
optionnals and, if a generation function is left unspecified, \verb+Frama_C+
mode (see the user manual~\cite{userman}) will be used instead to generate the
...
generated (emits a warning if omitted). Requires is the only clause for which it
