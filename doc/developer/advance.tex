...
\begin{itemize}
  \item For \texttt{Locations}:
    \texttt{src/kernel/services/abstract\_interp/locations.mli};
  \item For \texttt{Addresses}:
    \texttt{src/kernel/services/abstract\_interp/addresses.mli};
  \item For \texttt{Memory\_zone}:
    \texttt{src/kernel/services/abstract\_interp/memory\_zone.mli}.
\end{itemize}
