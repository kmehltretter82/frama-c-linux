...
\item \texttt{name} is an arbitrary, non-empty string containing the full name
  of the module. It must start with an uppercase letter and contain only
  letters and numbers, possibly separated by spaces, \texttt{-} or \texttt{\_}
\item \texttt{shortname} is a small, non-empty string containing the {\em short
  name} of the module, to be used as a prefix for all plug-in
