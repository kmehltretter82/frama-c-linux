...
\begin{shell}
frama-c -slevel 100 -eva *.c >log 2>&1
\end{shell}
...
\textbf{Note:} historically, \Eva{} was called Value, and most of its options
...
Example :
\begin{shell}
frama-c -eva -deps -out -save result file1.c file2.c
...
\begin{shell}
time frama-c -eva nor.c -slevel 2001
\end{shell}
...
\begin{shell}                                             
time frama-c -eva nor.c -slevel 2001 -no-results-function irrelevant_function
\end{shell}
...
option \texttt{-eva-numerors-domain}. The theory and core principles underlying
...
\begin{shell}
frama-c -eva -slevel 12 -lib-entry -main f reduction.c
\end{shell}
...
For instance, option
\lstinline|-eva-builtin malloc:Frama_C_malloc_fresh,free:Frama_C_free| enables
...
\lstinline|-eva-builtin| takes precedence over preexisting associations.
...
\begin{figure}
  \begin{centering}
    \begin{tabular}{lll}
      ...
      \tabularnewline
      \midrule
      Numerors & \lstinline|d-numerors| & \ref{sec:numerors}
      \tabularnewline
      \bottomrule
    \end{tabular}
    \par\end{centering}
