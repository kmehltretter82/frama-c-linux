...
enabling the log category of the given domain. These directives and domain log
categories are described in Section~\ref{buitins_observation}.
...
\begin{figure}
  \begin{centering}
    \begin{tabular}{lll}
      ...
      \midrule
      \midrule
      Symbolic equalities & \lstinline|d-eq| & \ref{sec:symbolic-equalities}
      \tabularnewline
      \midrule
    ...
    \end{tabular}
    \par\end{centering}
    \caption{Log categories for additional domains \label{fig:log-category}}
