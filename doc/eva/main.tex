...
and especially to the possible values of any expressions and memory locations
of any lvalues at each program point.
The idea behind the \lstinline|Results| API is that requests are decomposed
in several steps:
\begin{enumerate}
