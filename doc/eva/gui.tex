% TODO the GTK GUI has been removed
...
% C99-conformant cryptographic library that also includes a nice test
...
installing Frama-C. This requires node v24 and yarn:
\begin{itemize}
  \item install NVM: \url{https://github.com/nvm-sh/nvm}
  \item run \texttt{\em nvm install 24}
  \item run \texttt{\em nvm use 24}
...
\texttt{h5\ -=\ c5\ \textless{}\textless{}\ 25} in red, indicating that
...
\end{listing-nonumber}
In this example, all instructions ``terminate'' in the sense of
