...
This chapter provides additional information on the supported \textsf{ACSL} built-in symbols and, more generally,
...
Below in the section, additional information is given for each supported builtin, with a brief
