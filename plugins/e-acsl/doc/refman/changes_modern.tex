\section{Changes}
%\subsection*{Version Frama-C+dev}

\subsection*{Version Arsenic-33}
\begin{itemize}
  \item Update according to \acsl 1.24
    \begin{itemize}
...
\begin{itemize}
  \item Update according to \acsl 1.23
    \begin{itemize}
    \item Follow slight reorganization of \acsl.
    \item Add \lstinline|\aligned| builtin (Section~\ref{sec:pointers}).
    \end{itemize}
\end{itemize}

\subsection*{Version 1.22}
\begin{itemize}
  \item \changeinsection{inductivepredicates}{add support for a subset of
    inductive definitions}
\end{itemize}

\subsection*{Version 1.21}
\begin{itemize}
  \item No changes: changes in \acsl 1.21 do not impact \eacsl.
\end{itemize}
...
\subsection*{Version Germanium-32}
\begin{itemize}
  \item \changeinsection{memory}{support for \lstinline|\\aligned|}
\end{itemize}

\subsection*{Version Gallium-31}
\begin{itemize}
  \item \changeinsection{memory}{support for \lstinline|\\object_pointer|}
  \item \changeinsection{inductivepredicates}{add support for a subset of
    inductive definitions}
\end{itemize}

\subsection*{Version Chrome-24}
\begin{itemize}
