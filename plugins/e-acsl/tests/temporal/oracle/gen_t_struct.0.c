...
int main(void)
{
  ...
  t1.q = t1.p;
  {
    ...
    if (__gen_e_acsl_valid) {
      ...
      /*@ assert E_ACSL: "pointer alignment": \aligned(t1.q,1); */
      {
        ...
        __gen_e_acsl_assert_data_3.pred_txt = "\\aligned(t1.q,1)";
  ...
  /*@ assert \valid(t1.p) && \valid(t1.q); */ ;
  {
    ...
    __e_acsl_assert_data_t __gen_e_acsl_assert_data_4 =
      {.values = (void *)0};
    __gen_e_acsl_initialized = __e_acsl_initialized((void *)(& t2.p),
                                                    sizeof(char *));
    ...
    if (__gen_e_acsl_initialized) {
      ...
      /*@ assert E_ACSL: "pointer alignment": \aligned(t2.p,1); */
      {
        ...
        __gen_e_acsl_assert_data_5.pred_txt = "\\aligned(t2.p,1)";
    ...
    if (! __gen_e_acsl_and_2) {
      ...
      __gen_e_acsl_initialized_2 = __e_acsl_initialized((void *)(& t2.q),
                                                        sizeof(char *));
      ...
      if (__gen_e_acsl_initialized_2) {
        ...
        /*@ assert E_ACSL: "pointer alignment": \aligned(t2.q,1); */
        {
          ...
          __gen_e_acsl_assert_data_6.pred_txt = "\\aligned(t2.q,1)";
    ...
    __gen_e_acsl_assert_data_4.pred_txt = "!(\\initialized(&t2.p) && \\valid(t2.p)) &&\n!(\\initialized(&t2.q) && \\valid(t2.q))";
  ...
  __e_acsl_temporal_store_nblock((void *)(& t2.q),(void *)*(& t2.q));
  {
    ...
    if (__gen_e_acsl_initialized_3) {
      ...
      /*@ assert E_ACSL: "pointer alignment": \aligned(t2.p,1); */
      {
        ...
        __gen_e_acsl_assert_data_11.pred_txt = "\\aligned(t2.p,1)";
    ...
    if (! __gen_e_acsl_and_6) {
      ...
      /*@ assert E_ACSL: "pointer alignment": \aligned(t2.q,1); */
      {
        ...
        __gen_e_acsl_assert_data_12.pred_txt = "\\aligned(t2.q,1)";
    ...
    __gen_e_acsl_assert_data_10.pred_txt = "!(\\initialized(&t2.p) && \\valid(t2.p)) && \\valid(t2.q)";
  ...
  l.t = t2;
  {
    ...
    __e_acsl_assert_data_t __gen_e_acsl_assert_data_13 =
      {.values = (void *)0};
    __gen_e_acsl_initialized_4 = __e_acsl_initialized((void *)(& l.t.p),
                                                      sizeof(char *));
    ...
    if (__gen_e_acsl_initialized_4) {
      ...
      /*@ assert E_ACSL: "pointer alignment": \aligned(l.t.p,1); */
      {
        ...
        __gen_e_acsl_assert_data_14.pred_txt = "\\aligned(l.t.p,1)";
    ...
    if (! __gen_e_acsl_and_8) {
      ...
      /*@ assert E_ACSL: "pointer alignment": \aligned(l.t.q,1); */
      {
        ...
        __gen_e_acsl_assert_data_15.pred_txt = "\\aligned(l.t.q,1)";
    ...
    __gen_e_acsl_assert_data_13.pred_txt = "!(\\initialized(&l.t.p) && \\valid(l.t.p)) && \\valid(l.t.q)";
    __gen_e_acsl_assert_data_13.file = "t_struct.c";
    __gen_e_acsl_assert_data_13.fct = "main";
    __gen_e_acsl_assert_data_13.line = 41;
    __e_acsl_assert(__gen_e_acsl_and_9,& __gen_e_acsl_assert_data_13);
  ...
  lp = & l;
  {
    ...
    __e_acsl_assert_register_ptr(& __gen_e_acsl_assert_data_17,"lp",
                                 (void *)lp);
    ...
    /*@ assert E_ACSL: "pointer alignment": \aligned(lp,8); */
    {
      ...
      __gen_e_acsl_assert_data_17.pred_txt = "\\aligned(lp,8)";
    ...
    __gen_e_acsl_initialized_5 = __e_acsl_initialized((void *)(& lp->t.p),
                                                      sizeof(char *));
    ...
    if (__gen_e_acsl_initialized_5) {
      ...
      __e_acsl_assert_register_ptr(& __gen_e_acsl_assert_data_18,"lp",
                                   (void *)lp);
      ...
      /*@ assert E_ACSL: "pointer alignment": \aligned(lp,8); */
      {
        ...
        __gen_e_acsl_assert_data_18.pred_txt = "\\aligned(lp,8)";
      ...
      __e_acsl_assert_register_ptr(& __gen_e_acsl_assert_data_19,"lp->t.p",
                                   (void *)lp->t.p);
      ...
      /*@ assert E_ACSL: "pointer alignment": \aligned(lp->t.p,1); */
      {
        ...
        __gen_e_acsl_assert_data_19.pred_txt = "\\aligned(lp->t.p,1)";
        __gen_e_acsl_assert_data_19.file = "t_struct.c";
        __gen_e_acsl_assert_data_19.fct = "main";
        __gen_e_acsl_assert_data_19.line = 44;
      ...
      __gen_e_acsl_valid_read = __e_acsl_valid_read((void *)(& lp->t.p),
                                                    ...
                                                    (void *)(& lp->t.p),
                                                    (void *)0);
      __e_acsl_assert_register_ptr(& __gen_e_acsl_assert_data_20,"&lp->t.p",
                                   (void *)(& lp->t.p));
      ...
      /*@ assert E_ACSL: "memory access": \valid_read(&lp->t.p); */
      {
        ...
        __gen_e_acsl_assert_data_20.pred_txt = "\\valid_read(&lp->t.p)";
    ...
    __gen_e_acsl_assert_data_16.pred_txt = "!(\\initialized(&lp->t.p) && \\valid(lp->t.p))";
    __gen_e_acsl_assert_data_16.file = "t_struct.c";
    __gen_e_acsl_assert_data_16.fct = "main";
    __gen_e_acsl_assert_data_16.line = 44;
    __e_acsl_assert(! __gen_e_acsl_and_10,& __gen_e_acsl_assert_data_16);
  ...
  tarr[0] = t2;
  {
    ...
    __e_acsl_assert_data_t __gen_e_acsl_assert_data_21 =
      {.values = (void *)0};
    __gen_e_acsl_initialized_6 = __e_acsl_initialized((void *)(& tarr[0].p),
                                                      sizeof(char *));
    __e_acsl_assert_register_ptr(& __gen_e_acsl_assert_data_21,"&tarr[0].p",
                                 (void *)(& tarr[0].p));
    ...
    if (__gen_e_acsl_initialized_6) {
      ...
      __e_acsl_assert_register_ptr(& __gen_e_acsl_assert_data_22,"tarr[0].p",
                                   (void *)tarr[0].p);
      ...
      /*@ assert E_ACSL: "pointer alignment": \aligned(tarr[0].p,1); */
      {
        ...
        __gen_e_acsl_assert_data_22.pred_txt = "\\aligned(tarr[0].p,1)";
    ...
    if (! __gen_e_acsl_and_11) {
      ...
      __e_acsl_assert_register_ptr(& __gen_e_acsl_assert_data_23,"tarr[0].q",
                                   (void *)tarr[0].q);
      ...
      /*@ assert E_ACSL: "pointer alignment": \aligned(tarr[0].q,1); */
      {
        ...
        __gen_e_acsl_assert_data_23.pred_txt = "\\aligned(tarr[0].q,1)";
      ...
      __gen_e_acsl_valid_13 = __e_acsl_valid((void *)tarr[0].q,sizeof(char),
                                             (void *)tarr[0].q,
                                             (void *)(& tarr[0].q));
      __e_acsl_assert_register_ptr(& __gen_e_acsl_assert_data_21,"tarr[0].q",
                                   (void *)tarr[0].q);
      __e_acsl_assert_register_ulong(& __gen_e_acsl_assert_data_21,
                                     "sizeof(char)",0,sizeof(char));
      __e_acsl_assert_register_int(& __gen_e_acsl_assert_data_21,
    ...
    __gen_e_acsl_assert_data_21.pred_txt = "!(\\initialized(&tarr[0].p) && \\valid(tarr[0].p)) && \\valid(tarr[0].q)";
    __gen_e_acsl_assert_data_21.file = "t_struct.c";
    __gen_e_acsl_assert_data_21.fct = "main";
    __gen_e_acsl_assert_data_21.line = 47;
    __e_acsl_assert(__gen_e_acsl_and_12,& __gen_e_acsl_assert_data_21);
  ...
  larr[0] = l;
  {
    ...
    __e_acsl_assert_data_t __gen_e_acsl_assert_data_24 =
      {.values = (void *)0};
    __gen_e_acsl_initialized_7 = __e_acsl_initialized((void *)(& larr[0].t.p),
                                                      sizeof(char *));
    ...
    if (__gen_e_acsl_initialized_7) {
      ...
      /*@ assert E_ACSL: "pointer alignment": \aligned(larr[0].t.p,1); */
      {
        ...
        __gen_e_acsl_assert_data_25.pred_txt = "\\aligned(larr[0].t.p,1)";
    ...
    if (! __gen_e_acsl_and_13) {
      ...
      /*@ assert E_ACSL: "pointer alignment": \aligned(larr[0].t.q,1); */
      {
        ...
        __gen_e_acsl_assert_data_26.pred_txt = "\\aligned(larr[0].t.q,1)";
    ...
    __gen_e_acsl_assert_data_24.pred_txt = "!(\\initialized(&larr[0].t.p) && \\valid(larr[0].t.p)) && \\valid(larr[0].t.q)";
    __gen_e_acsl_assert_data_24.file = "t_struct.c";
    __gen_e_acsl_assert_data_24.fct = "main";
    __gen_e_acsl_assert_data_24.line = 50;
    __e_acsl_assert(__gen_e_acsl_and_14,& __gen_e_acsl_assert_data_24);
