...
int main(void)
{
    ...
    *(p + i) = (int *)malloc(4UL);
    __e_acsl_temporal_store_nblock((void *)(p + i),(void *)*(p + i));
    {
      ...
      /*@ assert E_ACSL: "pointer alignment": \aligned(p,8); */
      {
        ...
        __gen_e_acsl_assert_data_5.pred_txt = "\\aligned(p,8)";
      ...
      */
      ...
      /*@ assert E_ACSL: "pointer alignment": \aligned(p + i,8); */
      {
        ...
        __gen_e_acsl_assert_data_7.pred_txt = "\\aligned(p + i,8)";
      ...
      __e_acsl_assert_register_ptr(& __gen_e_acsl_assert_data_8,"*(p + i)",
                                   (void *)*(p + i));
      ...
      /*@ assert E_ACSL: "pointer alignment": \aligned(*(p + i),4); */
      {
        ...
        __gen_e_acsl_assert_data_8.pred_txt = "\\aligned(*(p + i),4)";
      ...
      /*@ assert E_ACSL: "memory access": \valid_read(p + i); */
      {
        ...
        __gen_e_acsl_assert_data_9.pred_txt = "\\valid_read(p + i)";
  ...
  malloc(4UL);
  {
    ...
    /*@ assert E_ACSL: "pointer alignment": \aligned(p + 2,8); */
    {
      ...
      __gen_e_acsl_assert_data_12.pred_txt = "\\aligned(p + 2,8)";
    ...
    __e_acsl_assert_register_ptr(& __gen_e_acsl_assert_data_13,"*(p + 2)",
                                 (void *)*(p + 2));
    ...
    /*@ assert E_ACSL: "pointer alignment": \aligned(*(p + 2),4); */
    {
      ...
      __gen_e_acsl_assert_data_13.pred_txt = "\\aligned(*(p + 2),4)";
    ...
    /*@ assert E_ACSL: "memory access": \valid_read(p + 2); */
    {
      ...
      __gen_e_acsl_assert_data_14.pred_txt = "\\valid_read(p + 2)";
