...
void build_tree(tree_desc *desc)
{
  ...
  extra = desc->extra_bits;
  {
    ...
    __e_acsl_assert_register_int(& __gen_e_acsl_assert_data_2,
                                 "uninitialized: \\initialized(&extra)",0,
                                 __gen_e_acsl_initialized);
    /*@ assert E_ACSL: uninitialized: \initialized(&extra); */
    {
      __gen_e_acsl_assert_data_2.blocking = 1;
      __gen_e_acsl_assert_data_2.kind = "RTE";
      __gen_e_acsl_assert_data_2.pred_txt = "\\initialized(&extra)";
    ...
    __e_acsl_assert_register_ptr(& __gen_e_acsl_assert_data_3,"extra",
                                 (void *)extra);
    ...
    /*@ assert E_ACSL: "pointer alignment": \aligned(extra,4); */
    {
      ...
      __gen_e_acsl_assert_data_3.pred_txt = "\\aligned(extra,4)";
      __gen_e_acsl_assert_data_3.file = "t_local_init.c";
      __gen_e_acsl_assert_data_3.fct = "build_tree";
...
int main(int argc, char const **argv)
{
  ...
  /*@ assert \valid_read(p); */ ;
  {
    ...
    /*@ assert E_ACSL: "pointer alignment": \aligned(p,8); */
    {
      ...
      __gen_e_acsl_assert_data_6.pred_txt = "\\aligned(p,8)";
  ...
  p = (char **)(& str);
  {
    ...
    /*@ assert E_ACSL: "pointer alignment": \aligned(p,8); */
    {
      ...
      __gen_e_acsl_assert_data_11.pred_txt = "\\aligned(p,8)";
  ...
  /*@ assert \valid_read(p); */ ;
  {
    ...
    /*@ assert E_ACSL: "pointer alignment": \aligned(*p,1); */
    {
      ...
      __gen_e_acsl_assert_data_15.pred_txt = "\\aligned(*p,1)";
    ...
    __e_acsl_assert(__gen_e_acsl_valid_read_6,& __gen_e_acsl_assert_data_12);
  ...
  __e_acsl_full_init((void *)(& P));
  {
    ...
    /*@ assert E_ACSL: "pointer alignment": \aligned(P,8); */
    {
      ...
      __gen_e_acsl_assert_data_19.pred_txt = "\\aligned(P,8)";
    ...
    __gen_e_acsl_assert_data_17.pred_txt = "\\valid_read(P)";
    __gen_e_acsl_assert_data_17.file = "t_local_init.c";
    __gen_e_acsl_assert_data_17.fct = "main";
    __gen_e_acsl_assert_data_17.line = 47;
    __e_acsl_assert(__gen_e_acsl_valid_read_7,& __gen_e_acsl_assert_data_17);
  ...
  /*@ assert \valid_read(P); */ ;
  {
    ...
    /*@ assert E_ACSL: "pointer alignment": \aligned(*P,1); */
    {
      ...
      __gen_e_acsl_assert_data_23.line = 48;
    ...
    __gen_e_acsl_assert_data_20.line = 48;
    __e_acsl_assert(__gen_e_acsl_valid_read_9,& __gen_e_acsl_assert_data_20);
  ...
  P = (char **)(& Str);
  {
    ...
    /*@ assert E_ACSL: uninitialized: \initialized(&P); */
    {
      ...
      __gen_e_acsl_assert_data_26.file = "t_local_init.c";
    ...
    /*@ assert E_ACSL: "pointer alignment": \aligned(P,8); */
    {
      ...
      __gen_e_acsl_assert_data_27.pred_txt = "\\aligned(P,8)";
      __gen_e_acsl_assert_data_27.file = "t_local_init.c";
      __gen_e_acsl_assert_data_27.fct = "main";
      __gen_e_acsl_assert_data_27.line = 52;
    ...
    __gen_e_acsl_assert_data_25.pred_txt = "\\valid_read(P)";
    __gen_e_acsl_assert_data_25.file = "t_local_init.c";
    __gen_e_acsl_assert_data_25.fct = "main";
    __gen_e_acsl_assert_data_25.line = 52;
    __e_acsl_assert(__gen_e_acsl_valid_read_10,& __gen_e_acsl_assert_data_25);
  ...
  /*@ assert \valid_read(P); */ ;
  {
    ...
    /*@ assert E_ACSL: uninitialized: \initialized(&P); */
    {
      ...
      __gen_e_acsl_assert_data_29.file = "t_local_init.c";
      __gen_e_acsl_assert_data_29.fct = "main";
      __gen_e_acsl_assert_data_29.line = 53;
    ...
    /*@ assert E_ACSL: "pointer alignment": \aligned(P,8); */
    {
      ...
      __gen_e_acsl_assert_data_30.pred_txt = "\\aligned(P,8)";
      __gen_e_acsl_assert_data_30.file = "t_local_init.c";
      __gen_e_acsl_assert_data_30.fct = "main";
      __gen_e_acsl_assert_data_30.line = 53;
    ...
    /*@ assert E_ACSL: "pointer alignment": \aligned(*P,1); */
    {
      ...
      __gen_e_acsl_assert_data_31.file = "t_local_init.c";
      __gen_e_acsl_assert_data_31.fct = "main";
      __gen_e_acsl_assert_data_31.line = 53;
    ...
    /*@ assert E_ACSL: "memory access": \valid_read(P); */
    {
      ...
      __gen_e_acsl_assert_data_32.pred_txt = "\\valid_read(P)";
      __gen_e_acsl_assert_data_32.file = "t_local_init.c";
      __gen_e_acsl_assert_data_32.fct = "main";
      __gen_e_acsl_assert_data_32.line = 53;
    ...
    __gen_e_acsl_assert_data_28.pred_txt = "\\valid_read(*P)";
    __gen_e_acsl_assert_data_28.file = "t_local_init.c";
    __gen_e_acsl_assert_data_28.fct = "main";
    __gen_e_acsl_assert_data_28.line = 53;
    __e_acsl_assert(__gen_e_acsl_valid_read_12,& __gen_e_acsl_assert_data_28);
