...
int main(int argc, char const **argv)
{
  ...
  /*@ assert \valid(p); */ ;
  {
    ...
    /*@ assert E_ACSL: uninitialized: \initialized(&q); */
    {
      ...
      __gen_e_acsl_assert_data_5.file = "t_char.c";
    ...
    __e_acsl_assert_data_t __gen_e_acsl_assert_data_6 =
      {.values = (void *)0};
    __gen_e_acsl_aligned_2 = __e_acsl_aligned((void *)q,1UL);
    ...
    /*@ assert E_ACSL: "pointer alignment": \aligned(q,1); */
    {
      ...
      __gen_e_acsl_assert_data_6.pred_txt = "\\aligned(q,1)";
      __gen_e_acsl_assert_data_6.file = "t_char.c";
