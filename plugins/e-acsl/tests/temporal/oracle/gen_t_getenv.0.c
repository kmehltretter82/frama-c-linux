...
int main(int argc, char const **argv)
{
  ...
  __e_acsl_full_init((void *)(& g2));
  {
    ...
    /*@ assert E_ACSL: uninitialized: \initialized(&g1); */
    {
      ...
      __gen_e_acsl_assert_data_2.pred_txt = "\\initialized(&g1)";
    ...
    /*@ assert E_ACSL: "pointer alignment": \aligned(g1,1); */
    {
      ...
      __gen_e_acsl_assert_data_3.pred_txt = "\\aligned(g1,1)";
    ...
    if (g1 == (char *)0) __gen_e_acsl_or = 1;
      ...
      /*@ assert E_ACSL: uninitialized: \initialized(&g1); */
      {
        ...
        __gen_e_acsl_assert_data_4.pred_txt = "\\initialized(&g1)";
      ...
      /*@ assert E_ACSL: "pointer alignment": \aligned(g1,1); */
      {
        ...
        __gen_e_acsl_assert_data_5.pred_txt = "\\aligned(g1,1)";
  ...
  /*@ assert g1 == \null || \valid(g1); */ ;
  {
    ...
    /*@ assert E_ACSL: uninitialized: \initialized(&g2); */
    {
      ...
      __gen_e_acsl_assert_data_7.pred_txt = "\\initialized(&g2)";
    ...
    /*@ assert E_ACSL: "pointer alignment": \aligned(g2,1); */
    {
      ...
      __gen_e_acsl_assert_data_8.pred_txt = "\\aligned(g2,1)";
    ...
    if (g2 == (char *)0) __gen_e_acsl_or_2 = 1;
      ...
      /*@ assert E_ACSL: uninitialized: \initialized(&g2); */
      {
        ...
        __gen_e_acsl_assert_data_9.pred_txt = "\\initialized(&g2)";
      ...
      /*@ assert E_ACSL: "pointer alignment": \aligned(g2,1); */
      {
        ...
        __gen_e_acsl_assert_data_10.pred_txt = "\\aligned(g2,1)";
