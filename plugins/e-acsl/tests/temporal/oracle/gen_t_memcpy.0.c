...
int main(void)
{
  ...
  /*@ assert \valid(src[0]); */ ;
  {
    ...
    /*@ assert E_ACSL: "pointer alignment": \aligned(src[1],4); */
    {
      ...
      __gen_e_acsl_assert_data_4.pred_txt = "\\aligned(src[1],4)";
  ...
  __gen_e_acsl_memcpy((void *)(& dest),(void const *)(& src),(size_t)size);
  {
    ...
    /*@ assert E_ACSL: "pointer alignment": \aligned(dest[0],4); */
    {
      ...
      __gen_e_acsl_assert_data_6.pred_txt = "\\aligned(dest[0],4)";
  ...
  /*@ assert \valid(dest[0]); */ ;
  {
    ...
    /*@ assert E_ACSL: "pointer alignment": \aligned(dest[1],4); */
    {
      ...
      __gen_e_acsl_assert_data_8.pred_txt = "\\aligned(dest[1],4)";
  ...
  __gen_e_acsl_memset((void *)(& dest),0,(size_t)size);
  {
    ...
    /*@ assert E_ACSL: "pointer alignment": \aligned(dest[0],4); */
    {
      ...
      __gen_e_acsl_assert_data_10.pred_txt = "\\aligned(dest[0],4)";
  ...
  *(p + 1) = & a;
  {
    ...
    /*@ assert E_ACSL: "memory access": \valid_read(p); */
    {
      ...
      __gen_e_acsl_assert_data_16.pred_txt = "\\valid_read(p)";
      __gen_e_acsl_assert_data_16.file = "t_memcpy.c";
      __gen_e_acsl_assert_data_16.fct = "main";
      __gen_e_acsl_assert_data_16.line = 40;
      __gen_e_acsl_assert_data_16.name = "memory access";
      __e_acsl_assert(__gen_e_acsl_valid_read,& __gen_e_acsl_assert_data_16);
  ...
  /*@ assert \valid(*p); */ ;
  {
    ...
    /*@ assert E_ACSL: "pointer alignment": \aligned(p,8); */
    {
      ...
      __gen_e_acsl_assert_data_18.pred_txt = "\\aligned(p,8)";
    ...
    /*@ assert E_ACSL: "pointer alignment": \aligned(p + 1,8); */
    {
      ...
      __gen_e_acsl_assert_data_19.pred_txt = "\\aligned(p + 1,8)";
    ...
    __e_acsl_assert_register_ptr(& __gen_e_acsl_assert_data_20,"*(p + 1)",
                                 (void *)*(p + 1));
    ...
    /*@ assert E_ACSL: "pointer alignment": \aligned(*(p + 1),4); */
    {
      ...
      __gen_e_acsl_assert_data_20.pred_txt = "\\aligned(*(p + 1),4)";
      ...
      __e_acsl_assert(__gen_e_acsl_aligned_11,& __gen_e_acsl_assert_data_20);
    ...
    /*@ assert E_ACSL: "memory access": \valid_read(p + 1); */
    {
      ...
      __gen_e_acsl_assert_data_21.pred_txt = "\\valid_read(p + 1)";
    ...
    __gen_e_acsl_valid_8 = __e_acsl_valid((void *)*(p + 1),sizeof(int),
                                          (void *)*(p + 1),(void *)(p + 1));
    __e_acsl_assert_register_ptr(& __gen_e_acsl_assert_data_17,"*(p + 1)",
                                 (void *)*(p + 1));
  ...
  /*@ assert \valid(*(p + 1)); */ ;
  {
    ...
    /*@ assert E_ACSL: "pointer alignment": \aligned(q,8); */
    {
      ...
      __gen_e_acsl_assert_data_23.pred_txt = "\\aligned(q,8)";
    ...
    /*@ assert E_ACSL: "pointer alignment": \aligned(*q,4); */
    {
      ...
      __gen_e_acsl_assert_data_24.pred_txt = "\\aligned(*q,4)";
    ...
    /*@ assert E_ACSL: "memory access": \valid_read(q); */
    {
      ...
      __gen_e_acsl_assert_data_25.pred_txt = "\\valid_read(q)";
  ...
  /*@ assert !\valid(*q); */ ;
  {
    ...
    /*@ assert E_ACSL: "pointer alignment": \aligned(q,8); */
    {
      ...
      __gen_e_acsl_assert_data_27.pred_txt = "\\aligned(q,8)";
      ...
      __e_acsl_assert(__gen_e_acsl_aligned_14,& __gen_e_acsl_assert_data_27);
    ...
    /*@ assert E_ACSL: "pointer alignment": \aligned(q + 1,8); */
    {
      ...
      __gen_e_acsl_assert_data_28.pred_txt = "\\aligned(q + 1,8)";
      ...
      __e_acsl_assert(__gen_e_acsl_aligned_15,& __gen_e_acsl_assert_data_28);
    ...
    __e_acsl_assert_register_ptr(& __gen_e_acsl_assert_data_29,"*(q + 1)",
                                 (void *)*(q + 1));
    ...
    /*@ assert E_ACSL: "pointer alignment": \aligned(*(q + 1),4); */
    {
      ...
      __gen_e_acsl_assert_data_29.pred_txt = "\\aligned(*(q + 1),4)";
      ...
      __e_acsl_assert(__gen_e_acsl_aligned_16,& __gen_e_acsl_assert_data_29);
    ...
    /*@ assert E_ACSL: "memory access": \valid_read(q + 1); */
    {
      ...
      __gen_e_acsl_assert_data_30.pred_txt = "\\valid_read(q + 1)";
  ...
  *q = tmp_1;
  ...
  __gen_e_acsl_memcpy((void *)q,(void const *)p,(size_t)size);
  {
    ...
    /*@ assert E_ACSL: "pointer alignment": \aligned(q,8); */
    {
      ...
      __gen_e_acsl_assert_data_32.line = 48;
      __gen_e_acsl_assert_data_32.name = "pointer alignment";
      __e_acsl_assert(__gen_e_acsl_aligned_17,& __gen_e_acsl_assert_data_32);
    ...
    /*@ assert E_ACSL: "pointer alignment": \aligned(*q,4); */
    {
      ...
      __gen_e_acsl_assert_data_33.line = 48;
      __gen_e_acsl_assert_data_33.name = "pointer alignment";
      __e_acsl_assert(__gen_e_acsl_aligned_18,& __gen_e_acsl_assert_data_33);
  ...
  /*@ assert \valid(*q); */ ;
  {
    ...
    /*@ assert E_ACSL: "pointer alignment": \aligned(q,8); */
    {
      ...
      __gen_e_acsl_assert_data_36.line = 49;
    ...
    /*@ assert E_ACSL: "pointer alignment": \aligned(q + 1,8); */
    {
      ...
      __gen_e_acsl_assert_data_37.pred_txt = "\\aligned(q + 1,8)";
      ...
      __e_acsl_assert(__gen_e_acsl_aligned_20,& __gen_e_acsl_assert_data_37);
    ...
    __e_acsl_assert_register_ptr(& __gen_e_acsl_assert_data_38,"*(q + 1)",
                                 (void *)*(q + 1));
    ...
    /*@ assert E_ACSL: "pointer alignment": \aligned(*(q + 1),4); */
    {
      ...
      __gen_e_acsl_assert_data_38.pred_txt = "\\aligned(*(q + 1),4)";
      __gen_e_acsl_assert_data_38.file = "t_memcpy.c";
      __gen_e_acsl_assert_data_38.fct = "main";
      __gen_e_acsl_assert_data_38.line = 49;
      __gen_e_acsl_assert_data_38.name = "pointer alignment";
      __e_acsl_assert(__gen_e_acsl_aligned_21,& __gen_e_acsl_assert_data_38);
    ...
    /*@ assert E_ACSL: "memory access": \valid_read(q + 1); */
    {
      ...
      __gen_e_acsl_assert_data_39.pred_txt = "\\valid_read(q + 1)";
      __gen_e_acsl_assert_data_39.file = "t_memcpy.c";
      __gen_e_acsl_assert_data_39.fct = "main";
      __gen_e_acsl_assert_data_39.line = 49;
    ...
    __gen_e_acsl_assert_data_35.line = 49;
    __e_acsl_assert(__gen_e_acsl_valid_12,& __gen_e_acsl_assert_data_35);
                          ...
                          size_t n)
{
  ...
  void *__retres;
  {
    ...
    __e_acsl_assert_register_int(& __gen_e_acsl_assert_data_5,
                                 "\"memory access\": \\valid_read((char *)dest + (0 .. n - 1))",
                                 0,__gen_e_acsl_valid_read_2);
    /*@ assert
          E_ACSL: "memory access": \valid_read((char *)dest + (0 .. n - 1));
    */
    {
      __gen_e_acsl_assert_data_5.blocking = 1;
    ...
    /*@ assert E_ACSL: "pointer alignment": \aligned(src,1); */
    {
      __gen_e_acsl_assert_data_6.blocking = 1;
      __gen_e_acsl_assert_data_6.kind = "E-ACSL RTE";
      __gen_e_acsl_assert_data_6.pred_txt = "\\aligned(src,1)";
    ...
    __e_acsl_assert_register_int(& __gen_e_acsl_assert_data_7,
                                 "\"memory access\": \\valid_read((char *)src + (0 .. n - 1))",
                                 0,__gen_e_acsl_valid_read_3);
    /*@ assert
          E_ACSL: "memory access": \valid_read((char *)src + (0 .. n - 1));
    */
    {
      __gen_e_acsl_assert_data_7.blocking = 1;
      __gen_e_acsl_assert_data_7.kind = "E-ACSL RTE";
      __gen_e_acsl_assert_data_7.pred_txt = "\\valid_read((char *)src + (0 .. n - 1))";
      ...
      __e_acsl_assert(__gen_e_acsl_valid_read_3,& __gen_e_acsl_assert_data_7);
      __e_acsl_assert_clean(& __gen_e_acsl_assert_data_7);
    }
