    ...
    if (__gen_e_acsl_assumes_value) {
      ...
      while (1) {
        ...
        }
        {
          ...
          __e_acsl_assert_register_uint(& __gen_e_acsl_assert_data_9,"j",0,
                                        __gen_e_acsl_j);
