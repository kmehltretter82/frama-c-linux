...
int main(void)
{
  ...
  /*@ assert !(\initialized(&p) && \freeable(p)); */ ;
  {
    ...
    __gen_e_acsl_assert_data_3.pred_txt = "!\\freeable((void *)0)";
    __gen_e_acsl_assert_data_3.file = "freeable.c";
    __gen_e_acsl_assert_data_3.fct = "main";
    __gen_e_acsl_assert_data_3.line = 15;
    __e_acsl_assert(! __gen_e_acsl_freeable_2,& __gen_e_acsl_assert_data_3);
  ...
  p = (int *)malloc(16UL);
  {
    ...
    __e_acsl_assert_data_t __gen_e_acsl_assert_data_4 =
      {.values = (void *)0};
    __gen_e_acsl_initialized_2 = __e_acsl_initialized((void *)(& p + 1),
                                                      sizeof(int *));
    ...
    __gen_e_acsl_assert_data_4.pred_txt = "!(\\initialized(&p + 1) && \\freeable(p + 1))";
  ...
  /*@ assert !(\initialized(&p + 1) && \freeable(p + 1)); */ ;
  {
    ...
    __gen_e_acsl_assert_data_6.pred_txt = "\\freeable(p)";
    __gen_e_acsl_assert_data_6.file = "freeable.c";
    __gen_e_acsl_assert_data_6.fct = "main";
    __gen_e_acsl_assert_data_6.line = 18;
    __e_acsl_assert(__gen_e_acsl_freeable_4,& __gen_e_acsl_assert_data_6);
  ...
  free((void *)p);
  {
    ...
    __e_acsl_assert(! __gen_e_acsl_freeable_5,& __gen_e_acsl_assert_data_8);
  ...
  /*@ assert !\freeable(p); */ ;
  {
    ...
    __e_acsl_assert_register_ptr(& __gen_e_acsl_assert_data_10,"&(array[0])",
                                 (void *)(array));
    ...
    __gen_e_acsl_assert_data_10.pred_txt = "!\\freeable(&(array[0]))";
    __gen_e_acsl_assert_data_10.file = "freeable.c";
    __gen_e_acsl_assert_data_10.fct = "main";
    __gen_e_acsl_assert_data_10.line = 23;
    __e_acsl_assert(! __gen_e_acsl_freeable_6,& __gen_e_acsl_assert_data_10);
  ...
  /*@ assert !\freeable(&(array[0])); */ ;
  {
    ...
    __e_acsl_assert_register_ptr(& __gen_e_acsl_assert_data_11,"&array[5]",
                                 (void *)(& array[5]));
    ...
    __gen_e_acsl_assert_data_11.pred_txt = "!\\freeable(&array[5])";
    __gen_e_acsl_assert_data_11.file = "freeable.c";
    __gen_e_acsl_assert_data_11.fct = "main";
    __gen_e_acsl_assert_data_11.line = 24;
    __e_acsl_assert(! __gen_e_acsl_freeable_7,& __gen_e_acsl_assert_data_11);
