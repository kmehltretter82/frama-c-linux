...
int __gen_e_acsl_main(int argc, char **argv)
{
    ...
    while (1) {
      if (__gen_e_acsl_k <= (long)argc) ; else break;
      {
        ...
        __e_acsl_assert_data_t __gen_e_acsl_assert_data_3 =
          {.values = (void *)0};
        __e_acsl_assert_register_long(& __gen_e_acsl_assert_data_3,"k",0,
                                      __gen_e_acsl_k);
        if ((-9223372036854775807L-1L) <= __gen_e_acsl_k) {
          __e_acsl_assert_register_long(& __gen_e_acsl_assert_data_3,"k",0,
                                        __gen_e_acsl_k);
          __gen_e_acsl_and = __gen_e_acsl_k <= 9223372036854775807L;
        }
        ...
        */
        {
          ...
          __gen_e_acsl_assert_data_3.pred_txt = "-9223372036854775808 <= k <= 9223372036854775807";
  ...
  /*@ assert \block_length(argv) == (argc + 1) * sizeof(char *); */ ;
  {
    ...
    /*@ assert E_ACSL: "pointer alignment": \aligned(argv,8); */
    {
      ...
      __gen_e_acsl_assert_data_7.pred_txt = "\\aligned(argv,8)";
    ...
    if ((-9223372036854775807L-1L) <= (long)argc) {
      __e_acsl_assert_register_int(& __gen_e_acsl_assert_data_8,"argc",0,
                                   argc);
      __gen_e_acsl_and_2 = (long)argc <= 9223372036854775807L;
    }
    else __gen_e_acsl_and_2 = 0;
    /*@ assert
          E_ACSL: "signed downcast":
            -9223372036854775808 <= argc <= 9223372036854775807;
    */
    {
      __gen_e_acsl_assert_data_8.blocking = 1;
      __gen_e_acsl_assert_data_8.kind = "E-ACSL RTE";
      __gen_e_acsl_assert_data_8.pred_txt = "-9223372036854775808 <= argc <= 9223372036854775807";
    ...
    /*@ assert E_ACSL: "pointer alignment": \aligned(argv + argc,8); */
    {
      ...
      __gen_e_acsl_assert_data_9.pred_txt = "\\aligned(argv + argc,8)";
    ...
    /*@ assert E_ACSL: "pointer alignment": \aligned(*(argv + argc),1); */
    {
      ...
      __gen_e_acsl_assert_data_10.pred_txt = "\\aligned(*(argv + argc),1)";
    ...
    /*@ assert E_ACSL: "memory access": \valid_read(argv + argc); */
    {
      ...
      __gen_e_acsl_assert_data_11.pred_txt = "\\valid_read(argv + argc)";
    ...
    __gen_e_acsl_assert_data_6.pred_txt = "*(argv + argc) == \\null";
    __gen_e_acsl_assert_data_6.file = "mainargs.c";
    __gen_e_acsl_assert_data_6.fct = "main";
    __gen_e_acsl_assert_data_6.line = 15;
    /*@ assert Eva: mem_access: \valid_read(argv + argc); */
    __e_acsl_assert(*(argv + argc) == (char *)0,& __gen_e_acsl_assert_data_6);
  ...
  /*@ assert *(argv + argc) == \null; */ ;
  {
    ...
    /*@ assert E_ACSL: "pointer alignment": \aligned(argv,8); */
    {
      ...
      __gen_e_acsl_assert_data_13.pred_txt = "\\aligned(argv,8)";
    ...
    if ((-9223372036854775807L-1L) <= (long)argc) {
      __e_acsl_assert_register_int(& __gen_e_acsl_assert_data_14,"argc",0,
                                   argc);
      __gen_e_acsl_and_3 = (long)argc <= 9223372036854775807L;
    }
    ...
    */
    {
      ...
      __gen_e_acsl_assert_data_14.pred_txt = "-9223372036854775808 <= argc <= 9223372036854775807";
    ...
    __e_acsl_assert_register_ptr(& __gen_e_acsl_assert_data_15,"argv",
                                 (void *)argv);
    __e_acsl_assert_register_int(& __gen_e_acsl_assert_data_15,"argc",0,argc);
    ...
    /*@ assert E_ACSL: "pointer alignment": \aligned(argv + argc,8); */
    {
      ...
      __gen_e_acsl_assert_data_15.pred_txt = "\\aligned(argv + argc,8)";
    ...
    /*@ assert E_ACSL: "pointer alignment": \aligned(*(argv + argc),1); */
    {
      ...
      __gen_e_acsl_assert_data_16.pred_txt = "\\aligned(*(argv + argc),1)";
    ...
    /*@ assert E_ACSL: "memory access": \valid_read(argv + argc); */
    {
      ...
      __gen_e_acsl_assert_data_17.pred_txt = "\\valid_read(argv + argc)";
    ...
    __gen_e_acsl_assert_data_12.pred_txt = "!\\valid(*(argv + argc))";
    __gen_e_acsl_assert_data_12.file = "mainargs.c";
    __gen_e_acsl_assert_data_12.fct = "main";
    __gen_e_acsl_assert_data_12.line = 16;
    __e_acsl_assert(! __gen_e_acsl_valid_2,& __gen_e_acsl_assert_data_12);
  ...
  while (i < argc) {
    {
      ...
      int len = (int)tmp;
      {
        ...
        /*@ assert E_ACSL: "pointer alignment": \aligned(argv,8); */
        {
          ...
          __gen_e_acsl_assert_data_19.pred_txt = "\\aligned(argv,8)";
        ...
        if ((-9223372036854775807L-1L) <= (long)i) {
          __e_acsl_assert_register_int(& __gen_e_acsl_assert_data_20,"i",0,i);
          __gen_e_acsl_and_4 = (long)i <= 9223372036854775807L;
        }
        ...
        */
        {
          ...
          __gen_e_acsl_assert_data_20.pred_txt = "-9223372036854775808 <= i <= 9223372036854775807";
          __gen_e_acsl_assert_data_20.file = "mainargs.c";
          __gen_e_acsl_assert_data_20.fct = "main";
          __gen_e_acsl_assert_data_20.line = 19;
          __gen_e_acsl_assert_data_20.name = "signed downcast";
          __e_acsl_assert(__gen_e_acsl_and_4,& __gen_e_acsl_assert_data_20);
        ...
        /*@ assert E_ACSL: "pointer alignment": \aligned(argv + i,8); */
        {
          ...
          __gen_e_acsl_assert_data_21.pred_txt = "\\aligned(argv + i,8)";
        ...
        /*@ assert E_ACSL: "pointer alignment": \aligned(*(argv + i),1); */
        {
          ...
          __gen_e_acsl_assert_data_22.pred_txt = "\\aligned(*(argv + i),1)";
        ...
        /*@ assert E_ACSL: "memory access": \valid_read(argv + i); */
        {
          ...
          __gen_e_acsl_assert_data_23.pred_txt = "\\valid_read(argv + i)";
        ...
        __e_acsl_assert(__gen_e_acsl_valid_3,& __gen_e_acsl_assert_data_18);
      ...
      /*@ assert \valid(*(argv + i)); */ ;
      {
        ...
        while (1) {
          if (__gen_e_acsl_k_2 <= (long)len) ; else break;
          {
            ...
            /*@ assert E_ACSL: "pointer alignment": \aligned(argv,8); */
            {
              ...
              __gen_e_acsl_assert_data_25.pred_txt = "\\aligned(argv,8)";
            ...
            __e_acsl_assert_register_int(& __gen_e_acsl_assert_data_26,"i",0,
                                         i);
            if ((-9223372036854775807L-1L) <= (long)i) {
              __e_acsl_assert_register_int(& __gen_e_acsl_assert_data_26,"i",
                                           0,i);
              __gen_e_acsl_and_5 = (long)i <= 9223372036854775807L;
            }
            ...
            */
            {
              ...
              __gen_e_acsl_assert_data_26.pred_txt = "-9223372036854775808 <= i <= 9223372036854775807";
              __gen_e_acsl_assert_data_26.file = "mainargs.c";
              __gen_e_acsl_assert_data_26.fct = "main";
              __gen_e_acsl_assert_data_26.line = 20;
              __gen_e_acsl_assert_data_26.name = "signed downcast";
              __e_acsl_assert(__gen_e_acsl_and_5,
            ...
            __e_acsl_assert_register_ptr(& __gen_e_acsl_assert_data_27,
                                         "argv",(void *)argv);
            __e_acsl_assert_register_int(& __gen_e_acsl_assert_data_27,"i",0,
                                         i);
            ...
            /*@ assert E_ACSL: "pointer alignment": \aligned(argv + i,8); */
            {
              ...
              __gen_e_acsl_assert_data_27.pred_txt = "\\aligned(argv + i,8)";
            ...
            */
            {
              ...
              __gen_e_acsl_assert_data_28.pred_txt = "\\aligned(*(argv + i),1)";
            ...
            __e_acsl_assert_register_ptr(& __gen_e_acsl_assert_data_29,
                                         "argv",(void *)argv);
            __e_acsl_assert_register_int(& __gen_e_acsl_assert_data_29,"i",0,
                                         i);
            ...
            /*@ assert E_ACSL: "memory access": \valid_read(argv + i); */
            {
              ...
              __gen_e_acsl_assert_data_29.pred_txt = "\\valid_read(argv + i)";
            ...
            __e_acsl_assert_data_t __gen_e_acsl_assert_data_30 =
              {.values = (void *)0};
            __e_acsl_assert_register_long(& __gen_e_acsl_assert_data_30,"k",
                                          0,__gen_e_acsl_k_2);
            if ((-9223372036854775807L-1L) <= __gen_e_acsl_k_2) {
              __e_acsl_assert_register_long(& __gen_e_acsl_assert_data_30,
                                            "k",0,__gen_e_acsl_k_2);
              __gen_e_acsl_and_6 = __gen_e_acsl_k_2 <= 9223372036854775807L;
            }
            ...
            */
            {
              ...
              __gen_e_acsl_assert_data_30.pred_txt = "-9223372036854775808 <= k <= 9223372036854775807";
              __gen_e_acsl_assert_data_30.file = "mainargs.c";
              __gen_e_acsl_assert_data_30.fct = "main";
              __gen_e_acsl_assert_data_30.line = 20;
              __gen_e_acsl_assert_data_30.name = "signed downcast";
        ...
        __gen_e_acsl_assert_data_24.pred_txt = "\\forall int k; 0 <= k <= len ==> \\valid(*(argv + i) + k)";
        __gen_e_acsl_assert_data_24.file = "mainargs.c";
        __gen_e_acsl_assert_data_24.fct = "main";
        __gen_e_acsl_assert_data_24.line = 20;
        __e_acsl_assert(__gen_e_acsl_forall_2,& __gen_e_acsl_assert_data_24);
