  ...
  *pmax = (char)76;
  ...
  __e_acsl_full_init((void *)(& diff));
  {
    ...
    /*@ assert E_ACSL: "pointer alignment": \aligned(pmin,1); */
    {
      ...
      __gen_e_acsl_assert_data_15.pred_txt = "\\aligned(pmin,1)";
  ...
  /*@ assert \valid(pmin); */ ;
  {
    ...
    /*@ assert E_ACSL: "pointer alignment": \aligned(pmax,1); */
    {
      ...
      __gen_e_acsl_assert_data_18.pred_txt = "\\aligned(pmax,1)";
  ...
  /*@ assert \valid(pmax); */ ;
  {
    ...
    /*@ assert E_ACSL: uninitialized: \initialized(&pmin); */
    {
      ...
      __gen_e_acsl_assert_data_20.pred_txt = "\\initialized(&pmin)";
    ...
    /*@ assert E_ACSL: "pointer alignment": \aligned(pmin,1); */
    {
      ...
      __gen_e_acsl_assert_data_21.pred_txt = "\\aligned(pmin,1)";
  ...
  /*@ assert !\valid(pmin + diff); */ ;
  {
    ...
    /*@ assert E_ACSL: uninitialized: \initialized(&pmax); */
    {
      ...
      __gen_e_acsl_assert_data_24.pred_txt = "\\initialized(&pmax)";
    ...
    /*@ assert E_ACSL: "pointer alignment": \aligned(pmax,1); */
    {
      ...
      __gen_e_acsl_assert_data_25.pred_txt = "\\aligned(pmax,1)";
