...
int main(void)
{
    ...
    while (i < 2) {
      ...
      /*@ assert t[2 - i] == 4 - i; */ ;
      {
        ...
        /*@ assert E_ACSL: "pointer alignment": \aligned(&t[2] - i,4); */
        {
          ...
          __gen_e_acsl_assert_data_24.pred_txt = "\\aligned(&t[2] - i,4)";
        ...
        /*@ assert E_ACSL: "memory access": \valid_read(&t[2] - i); */
        {
          ...
          __gen_e_acsl_assert_data_25.pred_txt = "\\valid_read(&t[2] - i)";
        ...
        __gen_e_acsl_initialized_12 = __e_acsl_initialized((void *)(& i),
                                                           sizeof(int));
        __e_acsl_assert_register_ptr(& __gen_e_acsl_assert_data_26,"&i",
                                     (void *)(& i));
        ...
        /*@ assert E_ACSL: uninitialized: \initialized(&i); */
        {
          ...
          __gen_e_acsl_assert_data_26.pred_txt = "\\initialized(&i)";
  ...
  t[2] = 5;
  {
    ...
    /*@ assert E_ACSL: "pointer alignment": \aligned(p,4); */
    {
      ...
      __gen_e_acsl_assert_data_29.pred_txt = "\\aligned(p,4)";
      ...
      __e_acsl_assert(__gen_e_acsl_aligned_3,& __gen_e_acsl_assert_data_29);
    ...
    /*@ assert E_ACSL: "memory access": \valid_read(p); */
    {
      ...
      __gen_e_acsl_assert_data_30.pred_txt = "\\valid_read(p)";
  ...
  __e_acsl_full_init((void *)(& k));
  {
    ...
    __gen_e_acsl_initialized_15 = __e_acsl_initialized((void *)(& k),
                                                       sizeof(int));
    __e_acsl_assert_register_ptr(& __gen_e_acsl_assert_data_34,"&k",
                                 (void *)(& k));
    ...
    /*@ assert E_ACSL: uninitialized: \initialized(&k); */
    {
      ...
      __gen_e_acsl_assert_data_34.pred_txt = "\\initialized(&k)";
    ...
    __e_acsl_assert_register_int(& __gen_e_acsl_assert_data_35,"k",0,k);
    ...
    /*@ assert E_ACSL: "pointer alignment": \aligned(p + k,4); */
    {
      ...
      __gen_e_acsl_assert_data_35.pred_txt = "\\aligned(p + k,4)";
    ...
    /*@ assert E_ACSL: "memory access": \valid_read(p + k); */
    {
      ...
      __gen_e_acsl_assert_data_36.pred_txt = "\\valid_read(p + k)";
