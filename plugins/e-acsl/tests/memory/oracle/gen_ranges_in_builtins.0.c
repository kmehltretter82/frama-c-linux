...
int main(void)
{
  ...
  int j = 2;
  {
    ...
    /*@ assert E_ACSL: "pointer alignment": \aligned(a,4); */
    {
      ...
      __gen_e_acsl_assert_data_4.pred_txt = "\\aligned(a,4)";
  ...
  /*@ assert \valid(a + (4 .. 7 + j)); */ ;
  {
    ...
    __gen_e_acsl_assert_data_5.pred_txt = "!\\valid(a + (10 .. 11))";
  ...
  b = (char *)malloc(10UL);
  {
    ...
    /*@ assert E_ACSL: "pointer alignment": \aligned(b,1); */
    {
      ...
      __gen_e_acsl_assert_data_8.pred_txt = "\\aligned(b,1)";
    ...
    __gen_e_acsl_assert_data_7.pred_txt = "\\valid(b + (0 .. 9))";
  ...
  /*@ assert \valid(b + (0 .. 9)); */ ;
  {
    ...
    /*@ assert E_ACSL: "pointer alignment": \aligned(b,1); */
    {
      ...
      __gen_e_acsl_assert_data_10.pred_txt = "\\aligned(b,1)";
    ...
    __gen_e_acsl_assert_data_9.pred_txt = "!\\valid(b + (10 .. 15))";
  ...
  __e_acsl_full_init((void *)(& t));
  {
    ...
    __gen_e_acsl_valid_6 = __e_acsl_valid((void *)((char *)(t) + 0),
                                          ...
                                          (void *)(t),(void *)0);
    __e_acsl_assert_register_ptr(& __gen_e_acsl_assert_data_11,"&(t[0])",
                                 (void *)(t));
    ...
    __gen_e_acsl_assert_data_11.pred_txt = "\\valid(&t[0 .. 2])";
  ...
  /*@ assert \valid(&t[0 .. 2]); */ ;
  {
    ...
    __gen_e_acsl_assert_data_12.pred_txt = "!\\valid(&t[3 .. 5])";
  ...
  t2[1] = 1.5;
  {
    ...
    __e_acsl_assert_register_ptr(& __gen_e_acsl_assert_data_13,"&(t2[0])",
                                 (void *)(t2));
    ...
    __gen_e_acsl_assert_data_13.pred_txt = "\\initialized(&t2[0 .. 1])";
  ...
  /*@ assert \initialized(&t2[0 .. 1]); */ ;
  {
    ...
    __gen_e_acsl_assert_data_14.pred_txt = "!\\initialized(&t2[2 .. 3])";
  ...
  /*@ assert !\initialized(&t2[2 .. 3]); */ ;
  {
    ...
    __gen_e_acsl_initialized_3 = __e_acsl_initialized((void *)(b + 0),
    ...
    __gen_e_acsl_assert_data_15.pred_txt = "!\\initialized(b + (0 .. 9))";
  ...
  int n = 2;
  {
    ...
    __gen_e_acsl_assert_data_17.pred_txt = "!\\initialized(&t3[n - 1 .. n + 2][1][0 .. 1])";
  ...
  /*@ assert !\initialized(&t3[n - 1 .. n + 2][1][0 .. 1]); */ ;
  {
    ...
    __gen_e_acsl_assert_data_18.pred_txt = "!\\valid_read(&t3[6][1][0] + (2 .. 10))";
    __gen_e_acsl_assert_data_18.file = "ranges_in_builtins.c";
    __gen_e_acsl_assert_data_18.fct = "main";
    __gen_e_acsl_assert_data_18.line = 53;
    __e_acsl_assert(! __gen_e_acsl_valid_read,& __gen_e_acsl_assert_data_18);
  ...
  /*@ assert !\valid_read(&t3[6][1][0] + (2 .. 10)); */ ;
  {
    ...
    __gen_e_acsl_assert_data_19.pred_txt = "\\valid_read(&t3[n - 1 .. n + 2][1])";
    ...
    __e_acsl_assert(__gen_e_acsl_forall_3,& __gen_e_acsl_assert_data_19);
  ...
  /*@ assert \valid_read(&t3[n - 1 .. n + 2][1]); */ ;
  {
    ...
    __gen_e_acsl_assert_data_20.pred_txt = "\\let x = 5; \\valid(&t4[4][0 .. x][2])";
  ...
  s.a[1] = 8;
  {
    ...
    __gen_e_acsl_initialized_5 = __e_acsl_initialized((void *)((char *)(& s.a[0]) + 4),
                                                      (size_t)__gen_e_acsl_if_12);
    __e_acsl_assert_register_ptr(& __gen_e_acsl_assert_data_21,"&s.a[0]",
                                 (void *)(& s.a[0]));
    ...
    __gen_e_acsl_assert_data_21.pred_txt = "\\initialized(&s.a[0] + (1 .. 1))";
    ...
    __e_acsl_assert(__gen_e_acsl_initialized_5,& __gen_e_acsl_assert_data_21);
  ...
  s.b = & sb;
  {
    ...
    __e_acsl_assert_register_ptr(& __gen_e_acsl_assert_data_23,"s.b",
                                 (void *)s.b);
    ...
    /*@ assert E_ACSL: "pointer alignment": \aligned(s.b,4); */
    {
      ...
      __gen_e_acsl_assert_data_23.pred_txt = "\\aligned(s.b,4)";
      ...
      __e_acsl_assert(__gen_e_acsl_aligned_7,& __gen_e_acsl_assert_data_23);
    ...
    __gen_e_acsl_initialized_6 = __e_acsl_initialized((void *)((char *)s.b + 0),
                                                      (size_t)__gen_e_acsl_if_13);
    __e_acsl_assert_register_ptr(& __gen_e_acsl_assert_data_22,"s.b",
                                 (void *)s.b);
    ...
    __gen_e_acsl_assert_data_22.pred_txt = "!\\initialized(s.b + (0 .. 1))";
  ...
  }
  {
    ...
    /*@ assert E_ACSL: "pointer alignment": \aligned(multi_dynamic,8); */
    {
      ...
      __gen_e_acsl_assert_data_25.pred_txt = "\\aligned(multi_dynamic,8)";
      __gen_e_acsl_assert_data_25.file = "ranges_in_builtins.c";
      __gen_e_acsl_assert_data_25.fct = "main";
      __gen_e_acsl_assert_data_25.line = 74;
    ...
    /*@ assert E_ACSL: "pointer alignment": \aligned(multi_dynamic + 4,8); */
    {
      ...
      __gen_e_acsl_assert_data_26.pred_txt = "\\aligned(multi_dynamic + 4,8)";
      __gen_e_acsl_assert_data_26.file = "ranges_in_builtins.c";
      __gen_e_acsl_assert_data_26.fct = "main";
      __gen_e_acsl_assert_data_26.line = 74;
    ...
    */
    {
      ...
      __gen_e_acsl_assert_data_27.pred_txt = "\\aligned(*(multi_dynamic + 4),4)";
    ...
    /*@ assert E_ACSL: "memory access": \valid_read(multi_dynamic + 4); */
    {
      ...
      __gen_e_acsl_assert_data_28.pred_txt = "\\valid_read(multi_dynamic + 4)";
      __gen_e_acsl_assert_data_28.file = "ranges_in_builtins.c";
      __gen_e_acsl_assert_data_28.fct = "main";
      __gen_e_acsl_assert_data_28.line = 74;
    ...
    __gen_e_acsl_assert_data_24.pred_txt = "\\valid(*(multi_dynamic + 4) + (1 .. 7))";
    __gen_e_acsl_assert_data_24.file = "ranges_in_builtins.c";
    __gen_e_acsl_assert_data_24.fct = "main";
    __gen_e_acsl_assert_data_24.line = 74;
    __e_acsl_assert(__gen_e_acsl_valid_9,& __gen_e_acsl_assert_data_24);
  ...
  __e_acsl_full_init((void *)(& t5));
  {
    ...
    __gen_e_acsl_valid_10 = __e_acsl_valid((void *)(t5 + 1 * 2),
                                           ...
                                           (void *)(t5),(void *)0);
    __e_acsl_assert_register_ptr(& __gen_e_acsl_assert_data_30,"&(t5[0])",
                                 (void *)(t5));
    ...
    __gen_e_acsl_assert_data_30.pred_txt = "\\valid(&t5[2 .. 3])";
    __gen_e_acsl_assert_data_30.file = "ranges_in_builtins.c";
    __gen_e_acsl_assert_data_30.fct = "main";
    __gen_e_acsl_assert_data_30.line = 86;
    __e_acsl_assert(__gen_e_acsl_valid_10,& __gen_e_acsl_assert_data_30);
