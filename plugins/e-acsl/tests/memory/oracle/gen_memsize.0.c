...
int main(int argc, char **argv)
{
  ...
  /*@ assert __e_acsl_heap_allocation_size == 16; */ ;
  {
    ...
    __e_acsl_assert_data_t __gen_e_acsl_assert_data_13 =
      {.values = (void *)0};
    __gen_e_acsl_initialized = __e_acsl_initialized((void *)(& b),
                                                    sizeof(char *));
  ...
  b = (char *)malloc(18446744073709551615UL);
  {
    ...
    __gen_e_acsl_assert_data_18.pred_txt = "__e_acsl_heap_allocation_size == 16";
    __gen_e_acsl_assert_data_18.file = "memsize.c";
    __gen_e_acsl_assert_data_18.fct = "main";
    __gen_e_acsl_assert_data_18.line = 61;
    __e_acsl_assert(__e_acsl_heap_allocation_size == 16UL,
  ...
  /*@ assert __e_acsl_heap_allocation_size == 16; */ ;
  {
    ...
    __e_acsl_assert_register_ptr(& __gen_e_acsl_assert_data_20,"b",(void *)b);
    ...
    /*@ assert E_ACSL: "pointer alignment": \aligned(b,1); */
    {
      ...
      __gen_e_acsl_assert_data_20.pred_txt = "\\aligned(b,1)";
      __gen_e_acsl_assert_data_20.file = "memsize.c";
      ...
      __e_acsl_assert(__gen_e_acsl_aligned_3,& __gen_e_acsl_assert_data_20);
    ...
    /*@ assert E_ACSL: uninitialized: \initialized(&b); */
    {
      ...
      __gen_e_acsl_assert_data_21.file = "memsize.c";
    ...
    __e_acsl_assert_register_ptr(& __gen_e_acsl_assert_data_19,"b",(void *)b);
    __gen_e_acsl_assert_data_19.blocking = 1;
    __gen_e_acsl_assert_data_19.kind = "Assertion";
    __gen_e_acsl_assert_data_19.pred_txt = "b == (char *)0";
    __gen_e_acsl_assert_data_19.file = "memsize.c";
    __gen_e_acsl_assert_data_19.fct = "main";
    __gen_e_acsl_assert_data_19.line = 62;
    __e_acsl_assert(b == (char *)0,& __gen_e_acsl_assert_data_19);
