    ...
    /*@ assert !(\initialized(&q) && \valid(q)); */ ;
    {
      ...
      if (__gen_e_acsl_initialized_4) {
        ...
        /*@ assert E_ACSL: "pointer alignment": \aligned(r,4); */
        {
          ...
          __gen_e_acsl_assert_data_9.pred_txt = "\\aligned(r,4)";
  ...
  /*@ assert !(\initialized(&q) && \valid(q)); */ ;
  {
    ...
    if (__gen_e_acsl_initialized_10) {
      ...
      /*@ assert E_ACSL: "pointer alignment": \aligned(r,4); */
      {
        ...
        __gen_e_acsl_assert_data_18.pred_txt = "\\aligned(r,4)";
...
int switch_valid(void)
{
      ...
      p = & a1;
      {
        ...
        /*@ assert \valid(q); */ ;
        {
          ...
          /*@ assert E_ACSL: "pointer alignment": \aligned(s,4); */
          {
            __gen_e_acsl_assert_data_9.blocking = 1;
            __gen_e_acsl_assert_data_9.kind = "RTE";
            __gen_e_acsl_assert_data_9.pred_txt = "\\aligned(s,4)";
            __gen_e_acsl_assert_data_9.file = "early_exit.c";
  ...
  /*@ assert !(\initialized(&p) && \valid(p)); */ ;
  {
    ...
    __gen_e_acsl_initialized_8 = __e_acsl_initialized((void *)(& s),
                                                      sizeof(int *));
    __e_acsl_assert_register_ptr(& __gen_e_acsl_assert_data_17,"&s",
                                 (void *)(& s));
    __e_acsl_assert_register_ulong(& __gen_e_acsl_assert_data_17,
                                   "sizeof(int *)",0,sizeof(int *));
    __e_acsl_assert_register_int(& __gen_e_acsl_assert_data_17,
    ...
    /*@ assert E_ACSL: uninitialized: \initialized(&s); */
    {
      __gen_e_acsl_assert_data_17.blocking = 1;
      __gen_e_acsl_assert_data_17.kind = "RTE";
      __gen_e_acsl_assert_data_17.pred_txt = "\\initialized(&s)";
      __gen_e_acsl_assert_data_17.file = "early_exit.c";
    ...
    __e_acsl_assert_register_ptr(& __gen_e_acsl_assert_data_18,"s",(void *)s);
    __e_acsl_assert_register_int(& __gen_e_acsl_assert_data_18,
    ...
    /*@ assert E_ACSL: "pointer alignment": \aligned(s,4); */
    {
      __gen_e_acsl_assert_data_18.blocking = 1;
      __gen_e_acsl_assert_data_18.kind = "RTE";
      __gen_e_acsl_assert_data_18.pred_txt = "\\aligned(s,4)";
      __gen_e_acsl_assert_data_18.file = "early_exit.c";
  ...
  }
  {
    ...
    if (__gen_e_acsl_initialized_10) {
      ...
      /*@ assert E_ACSL: "pointer alignment": \aligned(p,4); */
      {
        ...
        __gen_e_acsl_assert_data_21.pred_txt = "\\aligned(p,4)";
