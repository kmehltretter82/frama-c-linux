...
int __gen_e_acsl_raise(int sig)
{
  int __retres;
  {
    ...
    __gen_e_acsl_assert_data.line = 152;
...
void (*__gen_e_acsl_signal(int sig, void (*func)(int )))(int )
{
  ...
  void (*__retres)(int );
  {
    ...
    /*@ assert E_ACSL: "index out of bounds": 0 <= sig < (int)65; */
    {
      ...
      __gen_e_acsl_assert_data.line = 138;
    ...
    __gen_e_acsl_assert_data_3.line = 121;
    ...
    if (__gen_e_acsl_active_bhvrs != 1) {
      ...
      __gen_e_acsl_assert_data_7.line = 120;
      ...
      __gen_e_acsl_assert_data_8.line = 120;
      __e_acsl_assert(__gen_e_acsl_active_bhvrs <= 1,
  ...
  __retres = signal(sig,func);
  {
    ...
    __gen_e_acsl_assert_data_9.line = 128;
    ...
    /*@ assert E_ACSL: "index out of bounds": 0 <= \old(sig) < (int)65; */
    {
      ...
      __gen_e_acsl_assert_data_11.line = 130;
    ...
    __gen_e_acsl_assert_data_10.line = 130;
    ...
    if (__retres == SIG_ERR) __gen_e_acsl_or_2 = 1;
      ...
      /*@ assert E_ACSL: "index out of bounds": 0 <= \old(sig) < (int)65; */
      {
        ...
        __gen_e_acsl_assert_data_14.line = 133;
    ...
    if (__gen_e_acsl_assumes_value) {
      ...
      __gen_e_acsl_assert_data_15.line = 138;
    ...
    if (__gen_e_acsl_assumes_value) {
      ...
      __gen_e_acsl_assert_data_16.line = 144;
