...
/*
 * Reduced replay of Linux commit a25bc8486f9c0's parent.  Userspace could
 * encode a 16-byte KVM register size while kvm_arm_set_fw_reg() copied into
 * an 8-byte u64 stack object.
 */
