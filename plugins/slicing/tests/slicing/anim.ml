...
* To try it, use the following commands :
  ...
  make plugins/slicing/tests/slicing/anim.byte; \
  plugins/slicing/tests/slicing/anim.byte -deps -lib-entry -main g -slicing-level 3 -slice-callers \
                          plugins/slicing/tests/slicing/select_return_bis.c
*)
