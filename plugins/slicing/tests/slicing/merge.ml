...
* To try it, use the following commands :
  ...
  make plugins/slicing/tests/slicing/merge.byte; \
  plugins/slicing/tests/slicing/merge.byte -deps -lib-entry g -slicing-level 3 \
                          plugins/slicing/tests/slicing/merge.c
*)
