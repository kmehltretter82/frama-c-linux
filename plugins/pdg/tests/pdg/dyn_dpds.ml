(*
make -s plugins/pdg/tests/pdg/dyn_dpds.byte ; \
plugins/pdg/tests/pdg/dyn_dpds.byte -deps  plugins/pdg/tests/pdg/dyn_dpds.c; \
zgrviewer plugins/pdg/tests/pdg/dyn_dpds_1.dot ; \
zgrviewer plugins/pdg/tests/pdg/dyn_dpds_2.dot ;
*)
...
let get_zones str_data (stmt, kf) =
  ...
  let exp = Cil.new_exp ~loc:Kernel.gen_loc (Cil_types.Lval lval) in
