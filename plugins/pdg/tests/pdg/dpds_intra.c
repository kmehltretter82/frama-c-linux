...
*/
/* bin/toplevel.opt -deps -main g plugins/slicing/tests/slicing/dpds_intra.c */
/* bin/toplevel.opt -fct-pdg test_goto_simple plugins/slicing/tests/slicing/dpds_intra.c -pdg-dot */
...
./bin/toplevel.opt  -eva -main test_ctrl_dpd_multiple plugins/slicing/tests/slicing/dpds_intra.c
