...
#
# neon2sodium:
# convert a Frama-C plugin from Frama-C Neon to Frama-C Sodium
...
process_file ()
{
  ...
  sedi \
   -e "\"s/EmptyString/Empty_string/g\"" \
   -e "\"s/StringSet/String_set/g\"" \
   -e "\"s/StringList/String_list/g\"" \
   -e "\"s/Cil.kinteger64 ~loc \\([^~]\\)/Cil.kinteger64 ~loc ~kind:\\1/g\"" \
   -e "\"s/Integer.bits_of_max_float/Floating_point.bits_of_max_double/g\"" \
   -e "\"s/Integer.bits_of_most_negative_float/Floating_point.bits_of_most_negative_double/g\"" \
   -e "\"s/Cil.charConstToInt/Cil.charConstToIntConstant/g\"" \
   -e "\"s/Ival.neg/Ival.neg_int/g\"" \
   -e "\"s/Ival.sub/Ival.sub_int/g\"" \
   -e "\"s/Datatype.Big_int/Datatype.Integer/g\"" \
    $file
}
